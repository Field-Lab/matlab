...
% CRT data
datarun = load_data('/Volumes/lab/Experiments/Array/Analysis/2010-03-05-2/data013/data013');
...
% OLED data
datarun =  load_data('/Volumes/lab/Experiments/Array/Analysis/2012-04-13-1/data006/data006');

datarun =  load_data('/Users/gdfield/Analysis/2011-10-25-5/data001/data001');
datarun = load_data('/Users/gdfield/Analysis/2012-09-13-2/data005/data005');
...
gen_params.marks_thresh = 4.5; % sigmas: used to calculate the marks for RFs and TCs
gen_params.stixel_threshold = 4.5; % sigmas: used to calc marks for cell-wide sensitivity map
...
[new_locations, clicked_locations] = manual_cone_finding(datarun, {4}, cone_peaks, 'rad', 2);
