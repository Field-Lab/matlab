function [added_cones,first_dll,W,kernel_norms,num_kern_y,num_kern_x] = bayesian_cone_finding(datarun,bcf_params,roi_x,roi_y,W,kernel_norms)
%
%
...
if make_plots && 1
    ...
    start_index=1; index_min=1; index_max=num_rfs+1;

    figure(plot_fig + 2);clf
