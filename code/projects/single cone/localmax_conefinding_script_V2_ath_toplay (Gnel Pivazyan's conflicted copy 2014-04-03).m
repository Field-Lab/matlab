...
% OLED data
datarun = load_data('/Volumes/lab/Experiments/Array/Analysis/2012-09-13-2/data005/data005');

datarun =  load_data('/Volumes/lab/Experiments/Array/Analysis/2011-10-25-5/data001/data001');
datarun = load_data(fullfile(server_path(), '2012-09-13-2/data009/data009'));
datarun = load_data(fullfile(server_path(), '2012-09-13-2/data005/data005'));
