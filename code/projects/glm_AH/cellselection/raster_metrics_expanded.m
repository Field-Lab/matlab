...
pars.sigma_bin      = metricparams.smoothbins;
...
timescales = length(metricparams.smoothbins);

raster_scores = cell(timescales,1); i_timescale = 1;
%%
for i_timescale = 1:timescales
