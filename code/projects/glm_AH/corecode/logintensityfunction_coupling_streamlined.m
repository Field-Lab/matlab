function [lcif_cp, lcif_perneighbor] = logintensityfunction_coupling_streamlined (p_opt, Basepars, Slv_StimPars, datarun)
% Checked 2012-12-07   AK Heitman
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Streamlined Version already has datarun with spikes fed into it.

%Inputs: p_opt (final param values of the GLM)
...
for i_Neighbor  = 1 : nNeighbors
	...
	if ~isempty(n_slave_idx)
        ...
        if logical_BiDirectCP 
            display('%%%%%%%%%%%%%%%%ShiftSpike Hack for LCIF Coupling due to BiDirect Logic%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%') 
