%%% Ran on Bertha on 2012-12-16  at 6pm
%%% Basically the default package at different tolfuns
%%% Total of 2 cells over 2 preps and 4 runs
%%% BW metrics only
%%% 16 total runs ... roughly 1 hour per prep
%%% Runs for roughly 18 hours on Bertha
...
exp_nm  = '2012-08-09-3';  head_cellID = [1471 1786];
 %[1276 1426]; %% these will be the lead two for not debugging[1471 1786]
...
%{
exp_nm     = '2012-09-27-3';  head_cellID = [1 31];
for i = 1:4
    if i  == 1
        GLMPars.tolfun = 4;
    elseif i ==2
