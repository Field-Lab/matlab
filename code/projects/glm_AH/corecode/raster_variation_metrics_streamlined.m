function [Raster_Variability] = raster_variation_metrics_streamlined( RasterCell, raster_time, start_delay, end_early, maxpairs)
%%% AK Heitman
%%% streamlined version:   only looks at centi secs
...
% also gives general information of the Cell
