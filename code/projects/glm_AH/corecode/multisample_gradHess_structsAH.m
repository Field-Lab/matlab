...
function [gradient H] = multisample_gradHess_structsAH(Basepars,Stimpars,Trainpars,kernel_grad,kernel_hess,frozen_idx)
    ...
    if strcmp(Basepars.k_filtermode,'rk2') && correctionterm
      ...
      %  kernel = kernel_grad_blocked(tau+1:end);
        ...
        for iColumn = 0: tau-1
            ...
            % mex function call.. stopped working on 2013-01-24
            ...
            % Without the mex-function call 
            %movie_hessweighted_summed = movie(: , tau-iColumn: end -iColumn ) * skernel_grad_blocked;            
            %CrossTerm_rk2_Correction(: ,iColumn+1) = movie_hessweighted_summed;
