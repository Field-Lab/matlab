...
%metrics.shortname = 'fournormsPS';

exptests = [1]; metrics.shortname = 'fournormPSHO'; load /Users/akheitman/NSEM_Home/Cell_Selection/Raster_Metrics/base_crm_findPS_HO_expA.mat
%exptests = [1];  load /Users/akheitman/NSEM_Home/Cell_Selection/Raster_Metrics/base_crm_findPS_expA_OFF.mat; 
...
%%
    for i_celltype = celltypes
        ...
        if i_celltype == 1
            ...
            for i_metric = 1:4                
                model_comparison.scores{i_exp}.ONP_scores{i_metric} = NaN(2,length(cell_list));
            end
        elseif i_celltype == 2
            ...
            for i_metric = 1:4
                model_comparison.scores{i_exp}.OFFP_scores{i_metric} = NaN(2,length(cell_list));
            end
        end
%%
