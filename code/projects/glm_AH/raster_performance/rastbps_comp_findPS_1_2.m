...
% Version 1_2 Try to match with comp_importPS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
display('test takes about 30 seconds and ~15 iterations')
...
opt_params.ps_filter   = ps_basis *pstar( (end-20+1):end);
opt_params.ps_gain     = exp(ps_basis *pstar( (end-20+1):end));
end
