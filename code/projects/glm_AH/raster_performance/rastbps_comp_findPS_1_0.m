function [uop_bps crm_bps pstar] = rastbps_comp_findPS(inp_rast,t_bin,ps_basis,options)
...
% INPUT
clear; clc
load rastbps_comp_findPS_test_1.mat
display('test takes about 30 seconds to converge')
[uop_bps crm_bps pstar] = rastbps_comp_findPS(inp_rast,t_bin,ps_basis);
