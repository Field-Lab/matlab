...
for i_plot = [0 1 2 3 4 5];
    ...
    clf; hold on;
    if i_plot == 0
        transform = 'ID'; lineplot = true; norm_type = 'normsubtract';
    elseif i_plot == 1
        transform = 'logistic_3'; log_k=3; lineplot = true;norm_type = 'normsubtract';
    elseif i_plot == 2
        transform = 'ID'; lineplot = true; norm_type = 'normdivide';
    elseif i_plot == 3
        transform = 'logistic_3'; log_k=3; lineplot = true;norm_type = 'normdivide';
	elseif i_plot == 4
        transform = 'ID'; lineplot = true; norm_type = 'raw';
    elseif i_plot == 5
        transform = 'logistic_3'; log_k=3; lineplot = true;norm_type = 'raw';
    end
    ...
    for i_exp = exptests
        ...
        for i_celltype = 1:2
            if strcmp(norm_type, 'normsubtract')
                ...
                vals_A(find(vals_A <= -1)) = -1;
                vals_B(find(vals_B <= -1)) = -1;
