...
if strcmp(cellselectiontype, 'shortlist')    
    if expnumber == 1, cid_cell = {5161 841 5086 1471 841 1426 1772 2101 1276 3676}; end % 3676 and 1772 doesnt work for power raise on Bertha
...
if strcmp(cellselectiontype, 'debug')    
    if expnumber == 1, cid_cell = {5086}; end %{5086 841}
