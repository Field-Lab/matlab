% _CONV is a special one designed specifically to get nice convergence
% plots
...
new_xval_wrap_CONV(metric_type,exps,stimtypes,celltypes,CONV)
%}

function new_xval_wrap_CONV(metric_type,exps,stimtypes,celltypes,CONV)
...
GLMType0.stimfilter_mode = 'fixedSP_rk1_linear';
GLMType0.nullpoint = 'mean';  GLMType0.debug = false;
GLMType0.CONVEX = true; 
GLMType0.cone_model = 'DimFlash_092413Fc12_shift0'; GLMType0.cone_sname = 'timekernelCONEMODEL';
GLMType0.specialchange = false;
GLMType0.TonicDrive = true;
GLMType0.StimFilter = true;
GLMType0.PostSpikeFilter = true;
GLMType0.CouplingFilters = false;
GLMType0.fixed_spatialfilter = true;
...
for i_conv = CONV;
    ...
    GLMType.specialchange_name = sprintf('Fit_Convergence_%dPct', i_conv);
        ...
        for i_celltype = celltypes
            ...
            for i_cell = 1:length(cellgroup)
                ...
                elseif strcmp(metric_type, 'Viktor_Spike')
                    [scores] = rawcrossval_performance_ViktorSpike(rast_sim,rast_rec,rast_met.params.smoothbins);
                end
