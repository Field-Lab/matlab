...
%function [lg_p,input_term,cifs,kx,lg_p_breakdown] = train_ll3_lite(p,basepars,stimpars,trainpars,kxopt)
function [lg_p,input_term,cifs,az,lg_p_breakdown] = train_ll3_lite(p,basepars,stimpars,trainpars,kxopt)
