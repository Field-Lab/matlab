...
%%
function prep_STAandROI(stringdate, fit_type, map_type) 
...
fit_type = 'NSEM';
boolean_debug = false;
boolean_shortlist = true;
shortlist_cellID = {[841 1276 4021], [1471 1786 5086], [7652], [648]}; % [271];
 ...
 %  CID = datarun_mas.cell_types{n_ctype}.cell_id;
   ...
   %% RUN THROUGH EACH CELL .. PER CELL LOOP
    ...
    for n_cid = 1:length(CID) 
       ...
       subplot(2,1,1); 
       imagesc((STA(:,:,t_ind))'); colormap gray; colorbar; hold on
