% renamed 18 to avoid shadowing from other directories  (2013-12-04)
% ideallly would have done some subversion control thing but have not
...
function func_ras_blkdsnAH18(testrun,pdf_name)
%%
...
for k = 1:n_blk
   ...
   if rem(k,2) == 1
      ...
      if c1 == 1
         hold on
         title(sprintf('%s (id%4d): Repeat blocks',testrun.cell_type,testrun.cell_id))
         ylabel('Trial')
