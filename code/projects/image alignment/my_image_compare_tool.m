function [proj_axes] = my_image_compare_tool(left_image, right_image,fig_to_use)

% Create the figure
set(figure(fig_to_use),'Toolbar','none',...
    'Menubar','none',...
    'Name','My Image Compare Tool',...
    'NumberTitle','off');
hFig = gcf; 

% delete previous contents of the figure
clf(gcf)         
...
%return the axes of the left image
proj_axes = gca;
