...
% this one keep threshold the same,   just getting stats on these
% iterations
...
totaliter=10;
nrcluster=[100 50 50 30 30 30 30 30 30 20]
...
if 1
    if 1
        ...
        xml_switch=[0 totaliter+5 totaliter+10];
                    ...
                    for i=1:size(clusters.means,1)  %number of clusters
                        ...
                        if ~isempty(datarun.spikes{index})
                            ...
                            if(datarun.contamination(index)<=thr_contam); % contamination check  brings cell count down... and we get info for each on tcluster
                               ...
                               %  robust mean of the log of the "gain"
...
if 0 %save neurons
    ...
    data_path='/Volumes/Wheel/Data/Akheitman/2011-04-04-4/data000';
