...
% timefilter
[X_frame,X_bin]    = prep_stimcelldependentGPXV(GLMType, GLMPars, fitmovie, inputstats, center_coord, WN_STA, 0, timefilter);
clear WN_STA
...
p_init=[0.1*ones(paramind.convParams,1); pstar(paramind.space1); p_init_SU];

% Do optimization
[pstar fstar eflag output]     = fminunc(@(p) glm_SU_optim(p,convex_cov,stimulus, home_spbins,t_bin),p_init,optim_struct);
