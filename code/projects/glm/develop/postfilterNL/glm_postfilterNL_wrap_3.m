...
%{
clear; clc
exps = [1 2 3 4]; stimtypes = 1; celltypes = [2 1]; 
cell_subset = 'shortlist'; postfilterNL.debug = true;
%base_glmsettings = {}
        ...
        for i_celltype = celltypes            
            ...
            for i_cell = 1:length(cellgroup)
                ...
                [lcif,objval_OLD] = subR_lcifdecomp_fittedGLM(fittedGLM.rawfit.opt_params,...
                    fittedGLM.GLMType,fitspikes_concat,fitmovie_concat,inputstats,glm_cellinfo);
                ...
                [lcif_teststim_OLD] = subR_lcifstim_fittedGLM(fittedGLM.rawfit.opt_params,...
                    fittedGLM.GLMType,testmovie,inputstats,glm_cellinfo);
                ...
                printname = sprintf('%s/DiagNLPlot_%s',savedir, cell_savename);
...
function [lcif_stim]            = subR_lcifstim_fittedGLM(pstar, GLMType,fitmovie,inputstats,glm_cellinfo)
GLMPars           = GLMParams;
...
function [lcif, obj_val]        = subR_lcifdecomp_fittedGLM(pstar, GLMType,fitspikes,fitmovie,inputstats,glm_cellinfo)
