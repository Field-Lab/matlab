...
% Continuation of glm_postfilterNL_LNonly4  (started 2015-07-01)
% Now lets us factor in the Post-Spike Filter
        ...
        for i_celltype = celltypes            
            ...
            for i_cell = 1:length(cellgroup)
                ...
                if strcmp(postfilterNL.type, 'Logistic_fixMU_includePS')
                    NL_Input.fit_lcif_additionaldrive = baseGLM.lcif_fit.ps;
                end
                
                % CAREFULLY CONSTRAINED LOCAL SEARCH
                if fittedGLM.GLMType.PostSpikeFilter && strcmp(postfilterNL.type, 'Logistic_fixMU_noPS')
                ...
                elseif strcmp(postfilterNL.type, 'Logistic_fixMU_includePS')
                    NL_Output = LogFixMu_withPS_fmincon(NL_Input,home_spbins,t_bin);
                end
                ...
                if strcmp(postfilterNL.type,'Logistic_fixMU_includePS')
                    ...
                    NL_xvalperformance = subR_xvalperformance_GLM(NL_Output.crossvaltest_finalrate, recorded_raster, fittedGLM_preNL.t_bin, PS);
                end
                ...
                if strcmp(postfilterNL.type,'Logistic_fixMU_includePS')
                    fittedGLM.linearfilters.PostSpike = fittedGLM_preNL.linearfilters.PostSpike;
                end
