...
cell_subset = 'shortlist'; EM.debug = true;
base_glmsettings = {};
...
EM.type = 'displacement_NEGPOS_long_saccade_NEGPOS_long';
EM.shifts = [-25:50];
EM.saccade = [-10:30];
       ...
       % error('make this into a subroutine')  
        ...
        for i_celltype = celltypes            
            ...
            for i_cell = 1:length(cellgroup)
                ...
                p0 = [1, 1, 1, zeros(1,length(EM.saccade))]';
                ...
                lcif_sac0 = (new_p(4:end)') * COV_femshift_test;

                
               
            
                p0 = [1, 1, 1, 1, zeros(1,length( EM.saccade))]';
                COV = [lcif.mu; lcif.stim; lcif.ps; COV_femshift_fit; COV_sacshift_fit];
                [new_p new_objval eflag output] = fminunc(@(p) subr_optimizationfunction...
                        (p,COV,home_spbins,t_bin),p0,optim_struct);   
                ...
                xvalperformance_NEW.FEM_shifts = EM.shifts;
                xvalperformance_NEW.FEM_filter = EM.fitted_filter;
                ...
                if runoptions.print
                    ...
                    subplot(4,4,[5 6])
                    set(gca,'fontsize',10);
                    plot(EM.shifts, EM.fitted_filter,'r', 'linewidth',LW);
