...
function [uop_bps, uop_logprob_persec, crm_bps, crm_logprob_persec, opt_params] = rastbps_comp_findPS_variabletime(inp_rast,t_bin,ps_basis,smoothbins,options)
...
% CONSTRUCT THE UOP BY SMOOTHING WITH GAUSSIANS - PICK PARAMETERS
sig_val            = smoothbins; % unit of .8 msecs
convolve_dur       = 3; %
