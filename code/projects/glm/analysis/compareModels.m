...
% Version 8  cleaned up comparison name subroutine 2015-07-13
% Version 7  comparison name subroutine pushed to bottom
%            2015-07-13
...
%{
% Section 3: Other
'WN-InputPieceLin-InputSmooth-BothPSConstrain'
'WNstandardnoPS_vsNSEMfitcrossval'
'WNstandardnoPS_vsNSEMfitcrossval-oddeven'
'WNstandardnoPS_vsNSEMfitcrossval-oddevenDS'
'WNstandardnoPS_vsWNfitcrossval-oddevenDS'
'WNstandardnoPS_vsNSEMfitcrossval-oddeven3DS'
...
'NSEM-noPSnoCP-noPSnoSTIM'
'NSEM-standardGLM-standardGLMwithCP' 
'NSEM-standardGLM-rk1'
'NSEM-standardGLM-rk2'
'NSEM-standardGLMwithinputNL-netinhibPSCOB'
'NSEM-standardGLM-netinhibPSCOB'
'NSEM-noPSLogisticfixMU_vsLogisticfixMUnoPS'
...
'WN-standardGLM-standardGLMwithCP' 
'WN-stimnoCPnoPS-stimCPnoPS'
'WN-nostimnoPS-nostimnoPSwithCP'
'WN-stimnoPS-stimPS'
'WN-noPSLogisticfixMU_vsLogisticfixMUnoPS'
...
'WNvsNSEM_rk1noPS'  
'WNvsNSEM_rk2noPS'  
'WNvsNSEM-nostimnoPS-withCP'
'WNvsNSEM-GLMwithCPnoPS'
'WNvsNSEM-nostimnoPS'
'WNvsNSEM-standardGLMwithCP' 
'WNvsNSEM-standardGLM-noPS-LogisticfixMU'
'WNvsNSEM-inputNLpiecelinear-LogisticfixMUnoPS'
'WNvsNSEM-rk1'
'WNvsNSEM-rk2'
'WNvsNSEM-standardGLM-LogisticfixMUnoPS'
'WNvsNSEM-standardGLM-PSConstrain-Sub1'
%}
...
switch comparison_name
    ...
    case 'WN-InputPieceLin-InputSmooth-BothPSConstrain'
        ...
        plotparams.xlabel             = 'PieceLinear InputNL';
        plotparams.ylabel             = 'Smooth PowerRaise ';
        plotparams.title_comparison   = 'InputNL Compare';
    ...
    case 'WNstandardnoPS_vsNSEMfitcrossval-oddevenDS'
        ...
        plotparams.title_comparison   = 'Fun Comparison';
        plotparams.purpose            = 'If rk1 NSEM fit by test (but still crossvalidated), how does it do';
    case 'WNstandardnoPS_vsNSEMfitcrossval-oddeven3DS'
        models{1}.settings{1}.type = 'PostSpikeFilter';
        models{1}.settings{1}.name =  'OFF';
        models{1}.settings{2}.type = 'filter_mode';
        models{1}.settings{2}.name = 'rk1';
        ...
        models{2}.settings{2}.type = 'PostSpikeFilter';
        models{2}.settings{2}.name =  'OFF';
        models{2}.special_arg{1} = 'fit_crossval_oddeven_3DS';
        models{2}.fit_type = 'NSEM';
        plotparams.xlabel             = 'WN fit by Fit';
        plotparams.ylabel             = 'NSEM rk1 fit by test';
        plotparams.title_comparison   = 'Fun Comparison';
        plotparams.purpose            = 'If rk1 NSEM fit by test (downsampled space 3x factor..but still crossvalidated), how does it do';
	case 'WNstandardnoPS_vsWNfitcrossval-oddeven3DS'
        models{1}.settings{1}.type = 'PostSpikeFilter';
        models{1}.settings{1}.name =  'OFF';
        models{1}.settings{2}.type = 'filter_mode';
        models{1}.settings{2}.name = 'rk1';
        ...
        models{2}.fit_type = 'WN';
        plotparams.xlabel             = 'WN fit by Fit';
        plotparams.ylabel             = 'WN rk1 fit by test(DS 3)';
        plotparams.title_comparison   = 'Fun Comparison';
        plotparams.purpose            = 'WN fit by test vs WN fit by rast (downsample space by 3)';
    ...
    case 'WNvsNSEM-logpowerraise-constrainPS'
        ...
        models{1}.settings{1}.name = 'rieke_linear'
        models{1}.settings{2}.type= 'input_pt_nonlinearity';
        models{1}.settings{2}.name= 'log_powerraise';
        models{1}.special_arg{1} = 'PS_netinhibitory_domainconstrain_COB';
        models{1}.fit_type = 'WN';
        models{2}.settings{1}.type = 'cone_model';
        models{2}.settings{1}.name = 'rieke_linear';
        ...
        plotparams.xlabel             = 'White Noise';
        plotparams.ylabel             = 'Natural Scenes';
        plotparams.title_comparison   = 'SmoothInputNL';
        plotparams.purpose            = 'Check WN vs NSEM with constrained PS and smooth input NL';
