...
clear ; close all; clc;
%comparison_name = 'dWNvdNSEM-standardGLM-PSConstrain-Sub1';
%clear; close all; clc
%%comparison_name = 'dWNvdNSEM-standardGLM-noPS-LogisticfixMU';


comparison_name = 'dWNvdNSEM-standardGLM-noPS-Input4Piece-LogisticfixMUnoPS';

comparison_name = 'dWNvdNSEM-standardGLM-netinhibPSCOB';
cellselection_type = 'glmconv1pct';

%comparison_name = 'dWNvdNSEM-standardGLMInput4Piece-netinhibPSCOB';
%comparison_name = 'dWNvdNSEM-standardGLM-netinhibPSCOB';


% comparison_name = 'dWNvdNSEM-linearconesGLM-Input4Piece-netinhibPSCOB-LogisticfixMUwithPS';
% comparison_name = 'dWNvdNSEM-linearconesGLM-Input4Piece-LogisticfixMUwithPS';
% comparison_name = 'dWNvdNSEM-standardGLM-Input4Piece-netinhibPSCOB-LogisticfixMUwithPS';
% comparison_name = 'dWNvdNSEM-netinhibPSCOBOVER-Input4piece-LogisticfixMUwithPS';


clear
%comparison_name  = 'dWNvdNSEM-standardGLM-Input4Piece-netinhibPSCOB-LogisticfixMUwithPS';
%comparison_name = 'dWNvdNSEM-linearconesGLM-Input4Piece-netinhibPSCOB-LogisticfixMUwithPS';
%comparison_name = 'dWNvdNSEM-standardGLMnetinhibPSCOB-InputNLnetinhibPSCOB';
%comparison_name = 'dWNvdNSEM-standardGLMnetinhibPSCOB-InputNLLogisticfixMUnetinhibPSCOB';
comparison_name = 'dWNvdNSEM-noPSnoCP-noPSnoSTIM';
...
metrics = [2 5];
metrics = 7;
comparison_name = 'dWNvdNSEM-StimFilter-Mod-MUCP';
for i_metric = metrics
    ...
    if i_metric == 7, metric = 'VSPKD50msec'; end
    [model_comparison, outputnotes] = deltaWNvsdeltaNSEM(comparison_name,metric,cellselection_type)
end
%}

function [model_comparison, outputnotes] = deltaWNvsdeltaNSEM(comparison_name,metric,cellselection_type)
%% UNPACKING Comparison and Metic
% Default plotter : 2015-07-02

%error('need to change labels of old point new point to reflect that only one point');
%error('change upper and lower bounds on the victor spike plot')
...
if strcmp(comparison_name, 'dWNvdNSEM-StimFilter-Mod-MUCP')
    ...
    plotparams.title_comparison   = 'GLM mod(CP)';
    plotparams.purpose            = 'Improvement in scores from fitting GLM moduloCP (stim no PS CP vs. stim noPS CP)';
end
if strcmp(comparison_name, 'dWNvdNSEM-basetoNLN-rk1noPS')
...
if strcmp(comparison_name, 'dWNvdNSEM-basetoNLN-noPS')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
    models{1}.settings{2}.type = 'PostSpikeFilter';
    models{1}.settings{2}.name =  'OFF';
...
if strcmp(comparison_name, 'dWNvdNSEM-linearconescontrainPS-logpowerraiseconstrainPS')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
...
if strcmp(comparison_name, 'dWNvdNSEM-contrainPS-logpowerraiseconstrainPS')
    models{1}.settings= {};
    models{1}.special_arg{1} = 'PS_netinhibitory_domainconstrain_COB';
    models{2}.settings{1}.type = 'cone_model';
    models{2}.settings{1}.name = 'rieke_linear';
...
if strcmp(comparison_name, 'dWNvdNSEM-standardGLM-PSConstrain-Sub1')
    models{1}.settings = {};
    models{2}.settings = {};
...
if strcmp(comparison_name,'dWNvdNSEM-noPSnoCP-noPSnoSTIM')
...
if strcmp(comparison_name,'dWNvdNSEM-standardGLMwithlinearcones-inputNL')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
    models{2}.settings{1}.type = 'cone_model';
    models{2}.settings{1}.name = 'rieke_linear';
...
if strcmp(comparison_name,'dWNvdNSEM-standardGLMnetinhibPSCOB-InputNLnetinhibPSCOB')
    models{1}.settings = {}; 
    models{1}.special_arg{1}   = 'PS_netinhibitory_domainconstrain_COB';
...
if strcmp(comparison_name,'dWNvdNSEM-standardGLMnetinhibPSCOB-InputNLLogisticfixMUnetinhibPSCOB')
    models{1}.settings = {}; 
    models{1}.special_arg{1}   = 'PS_netinhibitory_domainconstrain_COB';
...
if strcmp(comparison_name, 'dWNvdNSEM-standardGLM-noPS-LogisticfixMU')
    models{1}.settings{1}.type = 'PostSpikeFilter';
    models{1}.settings{1}.name =  'OFF';
...
if strcmp(comparison_name, 'dWNvdNSEM-standardGLM-noPS-Input4Piece-LogisticfixMUnoPS');
    models{1}.settings{1}.type = 'PostSpikeFilter';
    models{1}.settings{1}.name =  'OFF';
...
if strcmp(comparison_name,'dWNvdNSEM-standardGLM-netinhibPSCOB')
    models{1}.settings = {};
    models{2}.settings = {};
    models{2}.special_arg{1}         = 'PS_netinhibitory_domainconstrain_COB';
...
if strcmp(comparison_name,'dWNvdNSEM-standardGLMInput4Piece-netinhibPSCOB')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
...
if strcmp(comparison_name,'dWNvdNSEM-linearconesGLM-Input4Piece-LogisticfixMUwithPS')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
...
if strcmp(comparison_name,'dWNvdNSEM-netinhibPSCOBOVER-Input4piece-LogisticfixMUwithPS')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
    models{1}.settings{2}.type = 'input_pt_nonlinearity';
    models{1}.settings{2}.name = 'piecelinear_fourpiece_eightlevels';
...
if strcmp(comparison_name,'dWNvdNSEM-standardGLM-Input4Piece-netinhibPSCOB-LogisticfixMUwithPS')
    models{1}.settings = {};
    models{2}.settings{1}.type = 'cone_model';
    models{2}.settings{1}.name = 'rieke_linear';
    models{2}.settings{2}.type = 'input_pt_nonlinearity';
...
if strcmp(comparison_name,'dWNvdNSEM-linearconesGLM-Input4Piece-netinhibPSCOB-LogisticfixMUwithPS')
    models{1}.settings{1}.type = 'cone_model';
    models{1}.settings{1}.name = 'rieke_linear';
...
switch metric
    ...
    case 'VSPKD50msec'
        ...
        normalize.doit = false;
        plotparams.low_lim = -.5;
        plotparams.high_lim = 0;
...
for i_exp = plotparams.exps
    ...
    for i_celltype = plotparams.celltypes
        ...
        scores(find(scores<=low_lim)) = low_lim;
        scores(find(scores>=high_lim)) = high_lim;
        
        plot(scores(:,1), scores(:,2), colorstring, 'markersize', MS_B);
        if i_celltype == 1
            %black highlight iinner white cirlce ..dumb idea
                   % plot(scores2(:,1), scores2(:,2),'k.', 'markersize', MS_A+1);
            plot(scores(:,1), scores(:,2),'w.', 'markersize', MS_A);
        elseif i_celltype == 2
            plot(scores(:,1), scores(:,2), 'k.', 'markersize', MS_A);
        end
...
for i_exp = plotparams.exps
    for i_celltype = plotparams.celltypes
        scores = [model_comparison.byexpnm{i_exp}.scores_bycelltype{i_celltype}.finalscores_model2 - ...
            model_comparison.byexpnm{i_exp}.scores_bycelltype{i_celltype}.finalscores_model1];
