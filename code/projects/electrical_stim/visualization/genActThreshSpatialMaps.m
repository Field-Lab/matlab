function [allEiAmps, allVals, actProb, actAmp] = genActThreshSpatialMaps(fPath,neuronId, varargin)
...
%                 disp([fPath fname]);
                ...
                if threshold > 0
                    ...
                    if assignValToPatternNo
                        ...
                        actThresholds(elecResp.stimInfo.electrodes) = threshold;
                    end
                    ...
                    if dispCheckedElecs
                        if assignValToPatternNo
                            ...
                            actThresholds(elecResp.stimInfo.electrodes) = 10;
                        end
                    end
                end
...
%                     end
%                 end
            end % end load elecResp files from a particular neuron 
        end
