...
patternNosCell = {[238 258 266 326 365] [142 160 123 94 69 384 415] [206 208 267 311 350 365]};
%neuronNum = 2013;
neuronNums = [3691 2252 3092];

movieInt = 0;
dp = '2015-12-18-0';


for n = 1:length(neuronNums);
	patternNos = patternNosCell{n};
	for i=[1 2 3];  
		%for k = [136 120 77 328 385];
		for k = patternNosCell{n};
		%for k = [27 451 439];
		%LOOP over all experiment folders
			...
			elecRespInfo.mainNeuron = neuronNums(n); 
