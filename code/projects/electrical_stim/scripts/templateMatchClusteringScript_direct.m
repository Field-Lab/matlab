...
%LOOP OVER MULTIPLE NEURONS
neuronNameVec = [4937 4967 5266 497 7591];
patternNosVecs = {[330 327] [330 327] [330 327] [330 327] [330 327]} ;
recElecVecs = {[327] [336] [347] [34] [499]};
numCells = 5;

for cll = 1:numCells;
	patternNos = patternNosVecs{cll};
	neuronName = neuronNameVec(cll)
