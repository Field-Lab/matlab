function MovieChunksFile = generateMovieClusterStim2Secondaries(clusterIDs, timeShiftInMs, delayInMs, smallAmpPatterns)


% usage:  MovieChunksFile = generateMovieClusterStim2Secondaries(clusterIDs, timeShiftInMs, delayInMs)
%
...
nChunks = ceil((timeShift + maxPatternsInCluster*2*delay)/40000); %factor of 2 is for 2 random orders
