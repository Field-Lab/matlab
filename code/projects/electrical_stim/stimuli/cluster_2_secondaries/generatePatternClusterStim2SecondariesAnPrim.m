function [arrayForCluster smallAmpPatterns] = generatePatternClusterStim2Secondaries(clusterElectrodes, centerElec, relAmps)
...
%
% Modified by GW to include patterns for stimulating with anodal primaries
% for pairs only, not triplets.  Called if includeAnodalPrimary is true in
% the script.
%
...
combinations = nearestNeighborsFinder(clusterElectrodes(surrElecInd));
