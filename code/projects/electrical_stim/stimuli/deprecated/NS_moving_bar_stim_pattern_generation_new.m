...
pathToNeuronsFile = '/Volumes/Brokedown/Analysis/Lauren/2010-10-18-3/data008/data008.neurons';
...
%stimAmps =       [.35  1.1  0.8  1.4  0.6  0.8];
...
save('moving_bar_data', 'spikeTimesCat', '-ascii', '-tabs')
