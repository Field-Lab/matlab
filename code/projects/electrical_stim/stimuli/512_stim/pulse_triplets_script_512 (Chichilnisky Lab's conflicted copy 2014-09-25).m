...
fid = fopen('pulse_triplets_ampSet4_electrodes','wb','ieee-le.l64');
fwrite(fid,electrodes,'int32');
fclose(fid);

fid = fopen('pulse_triplets_ampSet4_patterns','wb','ieee-le.l64');
fwrite(fid,Array,'double');  
fclose(fid);

fid = fopen('pulse_triplets_ampSet4_movie','wb','ieee-le.l64');
