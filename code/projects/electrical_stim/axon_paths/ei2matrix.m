...
h = load('/Users/vision/Dropbox/Lab/Development/matlab-standard/private/freddy/array_matrix_id510'); % Find a more general location for this or call a different text file. 
...
EImView = upsample(EIm',2)'; EImView(:,2:2:end) = EImView(:,1:2:end); 
