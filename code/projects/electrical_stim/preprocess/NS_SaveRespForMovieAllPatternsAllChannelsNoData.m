function [PDChunkNumber, MovieBegin, nRepeats, repeatPeriod]=NS_SaveRespForMovieAllPatternsAllChannelsNoData(FileName, WritePath, NS_GlobalConstants, traceLength)
