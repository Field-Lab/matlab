% v20 includes used fit frames
% NSEM needs to cut out certain frames
% Especially while using the cone model 
% better naming scheme for ever

%{
StimulusPars.NSEM.fittest_skipframes = 120;
StimulusPars.NSEM.fittest_skipsecs = 1;
StimulusPars.BW.fittest_skipframes = 0;
StimulusPars.BW.fittest_skipsecs = 0;
%}
...
function [StimulusPars DirPars datarun_slv datarun_mas] = Directories_Params_v20(string_date, slv_type, map_type)
...
StimulusPars.BW.triggers_perstaticblock    = 13;  % TRIGGERS PER STATIC RASTER BLOCK
StimulusPars.BW.triggers_pernovelblock   = 37;  % TRIGGERS PER NOVEL FITTING BLOCK    
StimulusPars.BW.seconds_perstaticblock   = 10; % SECONDS PER STATIC RASTER BLOCK  
StimulusPars.BW.seconds_pernovelblock  = 30; % SECONDS PER NOVEL FITTING BLOCK
StimulusPars.BW.frames_pernovelblock = fit_frames ;
StimulusPars.BW.frames_perstaticblock = raster_frames ;
...
StimulusPars.NSEM.triggers_perstaticblock   = 37;  % TRIGGERS PER STATIC RASTER BLOCK
StimulusPars.NSEM.triggers_pernovelblock  = 73;  % TRIGGERS PER NOVEL FITTING BLOCK    
StimulusPars.NSEM.seconds_perstaticblock  = 30; % SECONDS PER STATIC RASTER BLOCK  
StimulusPars.NSEM.seconds_pernovelblock = 60; % SECONDS PER NOVEL FITTING BLOCK
StimulusPars.NSEM.default_tstim = .00832750;
StimulusPars.NSEM.skipframes = 120;
...
StimulusPars.NSEM.frames_pernovelblock = 7200;
StimulusPars.NSEM.frames_perstaticblock = 3600;
...
if strcmp(exp_nm , '2013-10-10-0')
    ...
    StimulusPars.NSEM.FitMovieFiles = sort( union(StimulusPars.NSEM.FitBlocks, (StimulusPars.NSEM.FitBlocks +1)), 'ascend');
    StimulusPars.NSEM.NovelMovieFiles = sort( union(StimulusPars.NSEM.NovelBlocks, (StimulusPars.NSEM.NovelBlocks +1)), 'ascend');
    StimulusPars.NSEM.triggers_perstaticblock   = 145;  % TRIGGERS PER STATIC RASTER BLOCK
    StimulusPars.NSEM.triggers_pernovelblock  = 145;  % TRIGGERS PER NOVEL FITTING BLOCK    
    StimulusPars.NSEM.seconds_perstaticblock  = 120; % SECONDS PER STATIC RASTER BLOCK  
    StimulusPars.NSEM.seconds_pernovelblock = 120; % SECONDS PER NOVEL FITTING BLOCK
    StimulusPars.NSEM.frames_pernovelblock = 14400;
    StimulusPars.NSEM.frames_perstaticblock = 14400;
end
...
StimulusPars.BW.fittest_skipframes = 60;
StimulusPars.BW.fittest_skipsecs = .5;
StimulusPars.NSEM.fittest_skipframes = 120;
StimulusPars.NSEM.fittest_skipsecs = 1;

StimulusPars.BW.testframes = [ (StimulusPars.BW.fittest_skipframes + 1 ) : StimulusPars.BW.frames_perstaticblock];
StimulusPars.BW.testseconds= [ StimulusPars.BW.fittest_skipsecs , StimulusPars.BW.seconds_perstaticblock];
StimulusPars.NSEM.testframes = [ (StimulusPars.NSEM.fittest_skipframes + 1 ) : StimulusPars.NSEM.frames_perstaticblock];
StimulusPars.NSEM.testseconds= [ StimulusPars.NSEM.fittest_skipsecs , StimulusPars.NSEM.seconds_perstaticblock];


StimulusPars.BW.fitframes = [ (StimulusPars.BW.fittest_skipframes + 1 ) : StimulusPars.BW.frames_pernovelblock];
StimulusPars.BW.fitseconds= [ StimulusPars.BW.fittest_skipsecs , StimulusPars.BW.seconds_pernovelblock];
StimulusPars.NSEM.fitframes = [ (StimulusPars.NSEM.fittest_skipframes + 1 ) : StimulusPars.NSEM.frames_pernovelblock];
StimulusPars.NSEM.fitseconds= [ StimulusPars.NSEM.fittest_skipsecs , StimulusPars.NSEM.seconds_pernovelblock];
...
if nargout  >= 3
	...
	if strcmp(slv_type, 'BW')
        ntb_o  =  StimulusPars.BW.triggers_perstaticblock; ntb_e = StimulusPars.BW.triggers_pernovelblock; 
        n_blk = StimulusPars.BW.n_blk; n_rep = StimulusPars.BW.n_rep;
	elseif strcmp(slv_type, 'NSEM')
        ntb_o  =  StimulusPars.NSEM.triggers_perstaticblock; ntb_e = StimulusPars.NSEM.triggers_pernovelblock; 
