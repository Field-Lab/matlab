...
function [SimandMetrics]= compute_simtoraster_metrics2(Basepars,opt_param,plotRaster_dir)
...
if ~GLMPars.debug,   MetricPars.sims_pertrial = 10; end
...
SimandMetrics.BW   = BW_Simulations;    SimandMetrics.BW_RasterVariation = BW_RasterVariation;   
SimandMetrics.NSEM = NSEM_Simulations;  
if exist('NSEM_RasterVariation')
    SimandMetrics.NSEM_RasterVariation = NSEM_RasterVariation;
end
