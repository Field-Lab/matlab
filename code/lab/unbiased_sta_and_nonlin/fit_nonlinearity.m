...
% this function fits nonlinearity with a norm cdf. First it bins the gs and
% takes average spiking rate in each bin, and fits this average nonlinearity. 
% Then it takes the obtained parameters and fit the original (not averaged)
% gs.
% Inputs: 
%       - asr - actual spiking rate
%       - gs - generator signal (asr convolved with STA), same time bins as asr
%       - nbins - number of bins for first rough fit
