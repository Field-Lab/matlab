...
dialog = 'Name of workspace variable to save data';
if isempty(data)
    dialog = ['WARNING: ' dataname ' is empty!' sprintf('\n') dialog];
end

export_name = inputdlg(dialog, 'Save data', 1, {['gui_' dataname]});
if isempty(export_name), return; end

assignin('base', export_name{1}, data);