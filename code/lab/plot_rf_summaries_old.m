...
% contour_fill          []              color to fill contours
% contour_alpha         0.5             transparency of fill color
...
if params.label
    ...
    switch 1
        case 1
            plot_rf_labels(datarun, cell_specification, 'tform', tform, 'center_type', params.center_type, 'label_color', params.label_color, 'label_size', params.label_size, 'axes', plot_axes);
        case 2
            % TO DELETE - Abstracted into plot_rf_labels
            for cell_index = cell_indices
...
if params.array
    switch params.coordinates
        case 'monitor'
            plot_array(datarun,'r',[],params.array_label)
        case 'sta'
            T = coordinate_transform(datarun,'monitor');
            plot_array(datarun,'r',fliptform(T),params.array_label);
        otherwise
