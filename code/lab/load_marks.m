function [sta_fits] = load_marks(server_path, cell_ids, channels)
...
if (no_sta > 0)
  disp(['load_marks: no marks for ' num2str(no_sta) ' cells.']);
end
...
if file_name(7) == 'L'
  electrode = str2num(file_name(8:10));
  return
end
