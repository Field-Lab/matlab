function [threshold] = significant_stixels_threshold_calc(sta, false_stixels, varargin)
% significant_stixels     identify threshold for determining significant stixels
% "significant" stixels in an STA or RF 
%
% strategy:
%
...
%         case 'std'
            ...
            p = false_stixels/2/length(rf); % 1/2 the false stixels in each tail
            threshold = mean - norminv(p, mean, sigma);
