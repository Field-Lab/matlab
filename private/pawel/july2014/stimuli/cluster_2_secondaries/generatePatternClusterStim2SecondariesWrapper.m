function [electrodes Array clusterIDs smallAmpPatterns] = generatePatternClusterStim2SecondariesWrapper(centerElectrodes, relAmps, varargin)


% usage:  [electrodes Array clusterIDs] = generatePatternClusterStim2SecondariesWrapper(centerElectrodes, relAmps)
%
...
for i = 1:length(centerElectrodes)
    if ~includeAnodalPrimaries
        ...
        [arrayForEachCluster{i} smallAmpPatternsEachCluster{i}] = generatePatternClusterStim2SecondariesAnPrim(clusterElectrodes{i},...
            centerElectrodes(i), relAmps);
    end
end
