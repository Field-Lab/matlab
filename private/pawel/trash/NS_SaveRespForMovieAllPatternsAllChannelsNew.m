function [PDChunkNumber,MovieBegin,RepetNumber,RepetPeriod]=NS_SaveRespForMovieAllPatternsAllChannelsNew(FileName,WritePath,WritePathFigs,FigureProperties,NS_GlobalConstants);
