...
%if komp=='pokoj109'
    ...
    RawDataPath='G:\2012-03-27-01\Vision_output\data002'; %ja
    paramsFile='G:\2012-03-27-01\Vision_output\data002\data002.params';
    neuronFile = 'G:\2012-03-27-01\Vision_output\data002\data002.neurons';
    dane_path='G:\2012-03-27-01\dane';
...
a3=importdata('G:\2012-03-27-01\dane\good_neurons.txt');
...
for Neuron=1:length(idList)
    ...
    FullName=['G:\2012-03-27-01\dane\ID=' num2str(NeuronID)];
    ...
    for i=1:length(InterestingElectrodesFinal)
        ...
        CFs=NS512_FitWithMultiGaussKB(t,p);
    ...
    if length(InterestingElectrodesFinal)
        FullImageName=['G:\2012-03-27-01\images2\Neuron' num2str(NeuronID) '.tif']; % pokoj 109
        h=gcf;
...
FullName=['G:\2012-03-27-01\images2\GaussParameters.bin']; % pokoj 109
