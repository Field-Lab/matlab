...
% zmienne do definicji:
movies=[1:3:20];


for i=1:movies %NumberOfMovies-1 %unless specific movie numbers defined!! minus 1 because the last movie is expected to be empty
    if i>1
...
%ClusterFileName=NS_CreateClusterFile(WritePath,FileName,91,64,200)