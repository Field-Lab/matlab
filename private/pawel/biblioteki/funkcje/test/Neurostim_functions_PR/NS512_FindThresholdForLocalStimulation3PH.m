function [AmplitudesVsChannels,RMSVsChannelsAll]=NS512_FindThresholdForLocalStimulation3PH(DataPath,WritePathFigsGood,WritePathFigsBad,PatternNumber,Movies,Channels,ArrayID,FigureProperties,NS_GlobalConstants,MarkedChannels,Samples);
