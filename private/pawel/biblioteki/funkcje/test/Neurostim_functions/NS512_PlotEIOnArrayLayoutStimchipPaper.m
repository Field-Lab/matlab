function y=NS512_PlotEIOnArrayLayoutStimchipPaper(Traces,Channels,WaveformTypes,ArrayID,FigureProperties,NS_GlobalConstants,MarkedChannels,MarkedChannels2,t);
...
for c=max(WaveformTypes):-1:min(WaveformTypes)
    ...
    for i=1:NumberOfChannels
        ...
        if numerek
            ...
            h11=text(0.3,75,num2str(numerek));
