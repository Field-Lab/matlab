function [OutputEvents,SpikeBeyondTimeWindow] = FindSpikes2_PR(DataTraces,Channels,ThresholdNegative,ThresholdPositive,MinLatency,MaxLatency);
...
display('trelemorele')
OutputEvents = zeros(InputDataTracesSize(1),InputDataTracesSize(2));
OutputEvents(:,Channels) = Events;
%size(OutputEvents)
