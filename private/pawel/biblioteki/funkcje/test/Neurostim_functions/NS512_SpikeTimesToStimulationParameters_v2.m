function SpikeTimesCombined=NS512_SpikeTimesToStimulationParameters_v2(NeuronFilePath,MovieFilePath,DuplicatesFilePath,OutputPath);
...
%neuronie, na który moze sie skladac kilka neurons ID znalezione przez
%Vision. Stad tez w parametrach wejsciowych jest sciezka do pliku, który
