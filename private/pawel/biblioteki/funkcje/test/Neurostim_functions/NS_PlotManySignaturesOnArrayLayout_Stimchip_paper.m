function y=NS_PlotManySignaturesOnArrayLayout_Stimchip_paper(Traces,Channels,WaveformTypes,ArrayID,FigureProperties,NS_GlobalConstants);
...
for k=1:STraces(1) %for each signature...
    ...
    for i=1:ChannelsNumber
        ...
        if (Colors(WaveformColorIndex)~='n')         
            ...
            %h=text(xt,yt,num2str(Channels(i)));
