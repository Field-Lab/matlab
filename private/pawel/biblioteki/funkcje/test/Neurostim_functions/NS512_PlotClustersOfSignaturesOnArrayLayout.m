function y=NS512_PlotClustersOfSignaturesOnArrayLayout(Traces,Channels,WaveformTypes,ArrayID,FigureProperties,NS_GlobalConstants,t);
...
for c=max(WaveformTypes):-1:min(WaveformTypes)
    ...
    for i=1:NumberOfChannels
        ...
        if i==SE
            ...
            h=text(0.1,45,num2str(Channels(i)));
            set(h,'FontSize',FontSize);
