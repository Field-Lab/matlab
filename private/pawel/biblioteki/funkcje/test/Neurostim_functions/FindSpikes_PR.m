function [ Events ,SpikeBeyondTimeWindow ] = FindSpikes_PR(DataTraces,Channels,ThresholdNegative, ThresholdPositive, MinLatency, MaxLatency)
...
%   DataTraces - 3-D matrix - number of trace x number of electrode x sample
%   number, diamensions always 100 x 512 x 70(80?).
