function [OutputEvents,LatencyCriterion,HalfAmpCrossing]=NS512_FindSpikesThresholdForEachChannel(DataTraces,Channels,ThresholdsNegative,ThresholdsPositive,SpikeWidthRange,LatencyRange);
...
TracesSize = size(DataTraces); % no. of traces, no. of channels, no. of samples 
