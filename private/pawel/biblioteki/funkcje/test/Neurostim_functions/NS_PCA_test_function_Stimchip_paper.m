function [Types,TypesNew,EIs,Traces]=NS_PCA_test_function_Stimchip_paper(StimulatingChannel,MovieNumber,RecElectrodes,BadChannels,ReadPath,FileName,WritePath,NumberOfClusters,ClustersForDiff,TracesNumbers,FigureProperties);
...
%FigureProperties=struct('FigureNumber',17,'Subplot',[2 3
%3],'TimeRange',TimeRange,'AmplitudeRange',[-200 200],'FontSize',10,'Colors',['n' 'r' 'b' 'm' 'k']);
...
y18=NS_PlotManySignaturesOnArrayLayout_Stimchip_paper(EIs,neighbors,Types,ArrayID,FigureProperties,NS_GlobalConstants);
