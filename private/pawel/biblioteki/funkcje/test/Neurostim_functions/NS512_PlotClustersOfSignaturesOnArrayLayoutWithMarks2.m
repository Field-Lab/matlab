function y=NS512_PlotClustersOfSignaturesOnArrayLayoutWithMarks2(Traces,Channels,WaveformTypes,ArrayID,FigureProperties,NS_GlobalConstants,MarkedChannels,MarkedChannels2,t);
...
for c=max(WaveformTypes):-1:min(WaveformTypes)
    ...
    for i=1:NumberOfChannels
        X=(Coordinates(1,i)-X0)/Xspread+0.07; %0.15;
        X=(-Coordinates(1,i)+X0)/Xspread+0.69 %0.15;
        Y=(Coordinates(2,i)-Y0)/Yspread+0.11; %0.1;
        Y=(-Coordinates(2,i)+Y0)/Yspread+0.88 %0.1;
        XSize=Xstep/Xspread;
        YSize=Ystep/Yspread;        
