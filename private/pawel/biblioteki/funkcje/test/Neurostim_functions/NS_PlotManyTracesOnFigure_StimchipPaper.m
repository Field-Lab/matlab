function h=NS_PlotManyTracesOnFigure_StimchipPaper(FileName,Timings,WaveformTypes,Channel,OffsetCancellation,OffsetSamples,FigureProperties,Delay,NS_GlobalConstants)
