function [Responses,Noise]=NS512_ApplyLinearArtifactModel2(DataPath,PatternNumber,Movies,GoodChannels,TracesNumberLimit,EventNumber,ClusterFileName,NS_GlobalConstants);
