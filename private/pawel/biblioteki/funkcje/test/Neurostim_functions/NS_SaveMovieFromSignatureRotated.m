function M=NS_SaveMovieFromSignatureRotated(Traces,Channels,ElectrodeToShow,OversamplinFactor,ArrayID,WritePathFigs,NS_GlobalConstants);
...
for frame=1:NumberOfFrames*OversamplinFactor %for each frame...
    ...
    for i=1:ChannelsNumber
        ...
        X=(Coordinates(2,i)+Y0)/Yspread*1.2+0.6; %0.1;
        Y=(-Coordinates(1,i)+X0)/Xspread*1.25+1; %0.15;
    ...
    h=gcf;
    FullName=[WritePathFigs '\' 'frame' num2str(frame+6)];            
