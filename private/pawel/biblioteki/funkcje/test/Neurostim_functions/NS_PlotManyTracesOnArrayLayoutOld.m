function h=NS_PlotManyTracesOnArrayLayout(FileName,Channels,Timings,WaveformTypes,ArtifactCancellation,ArrayID,FigureNumber,FigureProperties,NS_GlobalConstants,ch);
...
for i=1:ChannelsNumber    
    ...
    %xlim(TimeRange);
    %text(1.5,70,num2str(Channels(i)));
    ...
    set(h,'YTick',[-200:50:100]);
    set(h,'YTickLabel',{'-200' '' '-100' '' '0' '' '100'});
    %hold off;
    if i==SE        
        set(h,'FontSize',FontSize);
        xlabel('Time [ms]');
