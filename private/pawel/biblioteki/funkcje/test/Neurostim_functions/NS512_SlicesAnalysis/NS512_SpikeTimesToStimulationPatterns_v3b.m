function [MovieNumber,RepetitionNumber,PatternNumber,Latency,TimeRelativeToRepetitionBegin,PreviousPattern]=NS512_SpikeTimesToStimulationPatterns_v3b(full_path,SpikeTime,MoviesBegins,NS_GlobalConstants);
...
if length(a)==0
    ...
    if PatternID>1
        PreviousPattern=MovieData(2+(PatternID-2)*3);
    else
        PreviousPattern=0;
    end
