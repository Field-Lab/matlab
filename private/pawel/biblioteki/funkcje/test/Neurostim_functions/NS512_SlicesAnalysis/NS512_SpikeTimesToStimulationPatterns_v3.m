function [MovieNumber,RepetitionNumber,PatternNumber,Latency,TimeRelativeToRepetitionBegin]=NS512_SpikeTimesToStimulationPatterns_v3(full_path,SpikeTime,MoviesBegins,NS_GlobalConstants);
