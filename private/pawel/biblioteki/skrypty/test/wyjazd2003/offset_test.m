...
y(4,:)=offsety(filename,length,stim_channel);

filename='ch28_110uA_01ms_Vpol-14_waterconv';
y(5,:)=offsety(filename,length,stim_channel);

filename='ch28_11uA_10ms_Vpol-14_waterconv';
y(6,:)=offsety(filename,length,stim_channel);

filename='ch28_14uA_10ms_Vpol-14_waterconv';
y(7,:)=offsety(filename,length,stim_channel);

filename='ch28_25uA_10ms_Vpol-11_waterconv';
y(8,:)=offsety(filename,length,stim_channel);

filename='ch28_52uA_10ms_Vpol-11_waterconv';
y(9,:)=offsety(filename,length,stim_channel);

filename='ch28_110uA_10ms_Vpol-11_waterconv';
y(10,:)=offsety(filename,length,stim_channel);
