...
StimElectrodes=[27 37 45 54 51 60 16];
RecElectrodes=[27 37 45 47 51 58 16];
NeuronsIDs=[391 541 616 691 736 856 227];
SpikesThresholds=[45 40 28 50 30 40 100 45]; 
ThresholdsForJitter=[30 30 40 10 30 40 40];
SpikeWidths=[4 3 3 8 3 6 3];
ThresholdsForJitter2=[45 30 40 20 70 60 40];
...
% histogramy:
for i=1:7
    h=subplot('position',[0.885,0.97-i*0.125,0.10,0.11]);    
