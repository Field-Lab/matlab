...
ReadPath='I:\2008-03-21-0';
WritePath='C:\home\pawel\nauka\Stimchip_paper\obrazki\figures_PCA';
FileName='003';

FigureProperties=struct('FigureNumber',200,'Subplot',[0],'TimeRange',[0 50],'AmplitudeRange',[-250 250],'FontSize',20,'Colors',['g' 'r' 'b' 'm' 'k'],'LineWidth',1);
...
FigureProperties.Colors=['b' 'k' 'b' 'r' 'g'];
