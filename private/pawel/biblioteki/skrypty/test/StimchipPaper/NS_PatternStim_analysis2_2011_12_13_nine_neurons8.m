...
subplot('position',[0.1 0.05 0.73 0.91]);
hold on;
...
set(h,'YTickLabel','');
h=xlabel('Time [ms]');
NS_StimPatternAnalysis_dodatek_nine_neurons3;

%break;
% histogramy:
for i=1:9
    h=subplot('position',[0.88,0.965-i*0.1,0.10,0.08]);    
...
set(h,'PaperSize',[18.7 17]);
set(h,'PaperPosition',[0 0 18.7 17]); 
