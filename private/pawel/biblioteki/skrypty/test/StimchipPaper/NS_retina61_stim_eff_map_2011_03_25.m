...
[227 391 406 541 616 736 901 856];
...
figure(200)
clf
subplot('Position',[0.05 0.18 0.84 0.75]);
%ghj=[2 3 5:12];
ghj=[2 5:8 10:12];
for k=1:length(ghj)    
    i=ghj(k);
...
%break;
figure(200)
FullName=['C:\home\pawel\nauka\Stimchip_paper\obrazki\map2.tif'];     
h=gcf;
set(h,'PaperUnits','inches');
set(h,'PaperSize',[18.7 3.7]);
set(h,'PaperPosition',[0 0 18.7 3.7]); 
