...
FigureProperties=struct('FigureNumber',23,'Subplot',[2 3 3],'TimeRange',[8 35],'AmplitudeRange',[-40 40],'FontSize',30,'Colors',['k' 'r' 'b' 'm' 'g' 'c' 'y'],'LineWidth',1,'YLabel','signal [mV]');
