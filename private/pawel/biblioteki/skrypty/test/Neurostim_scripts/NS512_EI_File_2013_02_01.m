...
%ClusterFilesPath='C:\pawel\nauka\analiza\retina\2012-09-27-4\files\ClusterFiles\';
%FileNameCore='data000_ID';
%for i=1:length(NeuronIDs)
%    ID=NeuronIDs(i);
%    FileName=[FileNameCore num2str(ID)];
%    ClusterFileName=NS_CreateClusterFile(ClusterFilesPath,FileName,63,512,50);
%end
