...
FigureNumber=225;
FigureProperties=struct('FigureNumber',FigureNumber,'TimeRange',TimeRange,'AmplitudeRange',[-100 350],'FontSize',FontSize,'FontName',FontName,'Colors',['k' 'r' 'b' 'y']);
Delay=0;
...
FigureProperties=struct('FigureNumber',FigureNumberZoom,'TimeRange',[-8 4],'AmplitudeRange',[-100 350],'FontSize',FontSize,'FontName',FontName,'Colors',['k' 'r' 'b' 'y']);
y=NS_PlotManyTracesOnFigure(FileName,Timings-1,WaveformTypes,Channel,3,[-365],FigureProperties,Delay,NS_GlobalConstants);
h=gca;
set(h,'XLim',[-0.4 0.2]);
hold on;
