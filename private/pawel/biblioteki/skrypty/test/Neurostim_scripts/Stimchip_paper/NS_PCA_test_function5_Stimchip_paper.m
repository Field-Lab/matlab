...
WritePath='C:\home\pawel\2010\Stimchip_paper\figures_PCA';
...
Types=NS_ClusterAndPrint_Stimchip_paper_2010_07_19(StimElectrodes,RecElectrodes,Movie,BadElectrodes,ReadPath,FileName,WritePath,NumberOfClusters,ClustersForDiff,TracesNumbers,FigureProperties);
%Types=NS_ClusterAndPrint_meeting(StimElectrodes,RecElectrodes,Movie,BadElectrodes,ReadPath,FileName,WritePath,NumberOfClusters,ClustersForDiff,TracesNumbers,FigureProperties);