...
NS_GlobalConstants=NS_GenerateGlobalConstants(NumberOfchannels);
DataPath='H:\2008-02-19\2008-02-19-1\data013';
...
for i = 1:length(MovieNumbers)
    ...
    %Amplitudes =FindAmplitudes_PR(
    %DataPath,1,MovieNumbers(i),[1:512],NS_GlobalConstants );
    %CurrentAmplitude = Amplitudes(max(size(Amplitudes)));
