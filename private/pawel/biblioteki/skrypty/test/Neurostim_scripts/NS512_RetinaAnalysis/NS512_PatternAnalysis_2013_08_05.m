...
VisionOutputPath='G:\analysis\2012-09-27-4\data000';
...
for i=1:length(Movies)
    ...
    MoviesAmplitudes(i)=NS_AmplitudesForPattern_512_1el('G:\analysis\2012-09-27-4\scan_new',2,2,MovieNumber,NS_GlobalConstants);
end
...
fid1=fopen('CrosstalkInfo2','w+');
fwrite(fid1,CrosstalkFile,'integer*2');
fclose(fid1);
% odczytanie pliku:
fid2=fopen('CrosstalkInfo2','r');
