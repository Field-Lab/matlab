...
for i=1:length(MoviesToAnalyze)-1
    ...
    EI_animation=reshape(mean(DataTraces2)-mean(DataTraces1),SDT1(2),SDT1(3));
    ...
    Delay=Delay0;
    for Delay=Delay0-5*UpsamplingFactor:Delay0+5*UpsamplingFactor    
        figure(120);
        clf
