...
FigureProperties=struct('FigureNumber',6,'TimeRange',[0 56],'AmplitudeRange',[-80 40],'FontSize',28,'Colors',['b' 'r' 'k' 'y'],'XTick',[0 0.5 1 1.5 2 2.5 3 3.5],'YTick',[-80:20:40],'LineWidth',2,'YLabel','Signal [\muV]');
%y=NS512_PlotClustersOfSignaturesOnArrayLayoutWithMarks4(T1,[Chns],[1 2],500,FigureProperties,NS_GlobalConstants,[144],[],[-0.2:0.05:4.75]);
...
h=gcf;
FullName=['C:\home\pawel\nauka\MEA2010\figures\' 'EIs_culture_rotated'];            
