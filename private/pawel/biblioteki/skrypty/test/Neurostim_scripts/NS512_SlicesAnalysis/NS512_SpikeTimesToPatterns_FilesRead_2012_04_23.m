...
for Neuron=1:length(idList)
    ...
    if length(InterestingElectrodesFinal)
        FullImageName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2012_04_23_KB\histograms\Neuron' num2str(NeuronID) '.tif']; % pokoj 109
        h=gcf;
...
FullName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2012_04_23_KB\histograms\GaussParameters.bin']; % pokoj 109
