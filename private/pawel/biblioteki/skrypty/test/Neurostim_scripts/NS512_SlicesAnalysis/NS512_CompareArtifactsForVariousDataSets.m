...
for i=1:17
    [StimChannels,Amplitudes]=NS_StimulatedChannels(DataPath1,StimElectrodes(ElectrodeID),MovieFirst1(ElectrodeID)+(i-1)*14,[1:512],NS_GlobalConstants)
    Amplitude1(i)=Amplitudes(1);
end

%set2:
for i=1:17
    [StimChannels,Amplitudes]=NS_StimulatedChannels(DataPath2,StimElectrodes(ElectrodeID),MovieFirst2(ElectrodeID)+(i-1)*14,[1:512],NS_GlobalConstants);
