...
DataPath='I:\analysis\slices\2010-09-14-0\analysis-2014-08-20\SpikeFiles';
...
for Frame=1:length(TimePoints)
    ...
    for i=1:length(Movies)
        ...
        hold on;
        for Channel=Channels
            TotalNumberOfSpikes=sum(SpikeTimesHistograms(i,Channel,:));
            SpikeNumber=SpikeTimesHistograms(i,Channel,Frame);
            if SpikeNumber>0 & TotalNumberOfSpikes>5
                if SpikeNumber>50
                    SpikeNumber=50;
                end
