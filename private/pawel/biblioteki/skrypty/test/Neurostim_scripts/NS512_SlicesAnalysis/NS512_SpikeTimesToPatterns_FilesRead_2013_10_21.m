...
komp='pokoj109';
if komp=='pokoj109'
    RawDataPath='G:\data\2010-09-14-0\data005'; %pokoj 109
    ...
    dane_path='C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2013_10_02\data005\dane';
else
...
for Neuron=1%:length(idList)
    ...
    if length(InterestingElectrodesFinal)
        FullImageName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2013_10_02\data005\histograms4\Neuron' num2str(NeuronID) '.tif']; % pokoj 109
        h=gcf;
