...
for neuron=8%1:length(PrimaryNeurons)
    ...
    for p=1:length(SuspectedPatterns)% for each pattern tha was associated with a least one spike
        ...
        if Stimulation==1 %jesli flaga jest 1, czyli jesli ten pattern stymulowal ten neuron dla przynajmniej jednej amplitudy...
            ...
            FigurePath='D:\Home\Pawel\analysis\slices\2013\2013-12-12-3-PH\data001_Matlab\figures4test';
...
fid = fopen('D:\Home\Pawel\analysis\slices\2013\2013-12-12-3-PH\data001_Matlab\figures4test\NeuronsPatterns.bin','wb');
