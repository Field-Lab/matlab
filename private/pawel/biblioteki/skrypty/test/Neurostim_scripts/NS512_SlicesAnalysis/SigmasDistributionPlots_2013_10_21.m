...
h=gca
set(h,'FontSize',10)
FullImageName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2013_10_02\data005\other_plots\sigmas_histogram.tif'];
h=gcf;
...
set(h,'FontSize',10)
set(h,'XLim',[0 30])
FullImageName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2013_10_02\data005\other_plots\latency_vs_sigma.tif'];
h=gcf;
set(h,'PaperUnits','inches');
set(h,'PaperSize',[4 3]);
set(h,'PaperPosition',[0 0 4 3]); 
...
set(h,'FontSize',10)
set(h,'YLim',[0 30])
FullImageName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2013_10_02\data005\other_plots\distance_vs_latency.tif'];
h=gcf;
set(h,'PaperUnits','inches');
set(h,'PaperSize',[4 3]);
set(h,'PaperPosition',[0 0 4 3]); 
...
set(h,'FontSize',10)
%set(h,'YLim',[0 30])
FullImageName=['C:\home\Pawel\nauka\analiza\SlicesTTX\2010-09-14-0\analysis_2013_10_02\data005\other_plots\distance_vs_sigma.tif'];
h=gcf;
set(h,'PaperUnits','inches');
set(h,'PaperSize',[4 3]);
set(h,'PaperPosition',[0 0 4 3]); 
...
clf
hold on
for i=1:length(InDirectStimulation)
