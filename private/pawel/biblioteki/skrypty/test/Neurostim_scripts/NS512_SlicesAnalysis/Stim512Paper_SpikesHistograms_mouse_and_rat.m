...
%GaussesFilesPath='D:\Home\Pawel\analysis\slices\512stim_paper\SpikesAnalysis\2010-09-14-0\data005\GaussesFiles-2015-05-24\';
%SPFilesPath='C:\home\Pawel\nauka\512stim_paper\SpikesAnalysis\2010-09-14-0\data005\sp_files\';
%FiguresPath='D:\Home\Pawel\analysis\slices\512stim_paper\SpikesAnalysis\2010-09-14-0\data005\GaussesFigures-2015-05-24\';
...
for Pattern=AllPatternsUsed%(1:7)
    ...
    for Electrode=InterestingElectrodes%(5)
        ...
        CFs=NS512_FitWithMultiGauss_2015_05_24([1:600],HistogramsAll);
        for g=1:length(CFs)
