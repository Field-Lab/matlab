...
Movies=[87:2:151]; %ktore amplitudy, domyslnie [1:2:151]

Patterns=[1];
Movies=[71];
WritePathFigs='D:\Home\Rydygier\NEURO\analysis\retina\2009-11-27-0\data001\April2010\figures\50us_met7';
...
for i=1:length(Patterns)
    ...
    AmplitudesVsChannelsAll_100us=[AmplitudesVsChannelsAll_100us' AmplitudesVsChannels']';
    RMSVsChannelsAll = [RMSVsChannelsAll' RMSVsChannels']';
end
cd D:\Home\Rydygier\NEURO\analysis\retina\2009-11-27-0\data001\April2010\figures;
save('AmplitudesVsChannels_100us.mat','AmplitudesVsChannelsAll_100us');
