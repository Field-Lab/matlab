...
print(hc, '-dtiff', '-r120', 'D:\Home\Pawel\Traces');
...
set(hc,'PaperSize',[10 7]);
set(hc,'PaperPosition',[0 0 10 7]);
print(hc, '-dtiff', '-r120', 'D:\Home\Pawel\TracesZoom');

%set('XTickLabel',{'-0.4 '' -

%3) Finding the EIs based on elicited spikes and plotting it in fig. 133
full_path='H:\2008-02-04-0\data004';
...
full_path='H:\2008-02-04-0\data005';
