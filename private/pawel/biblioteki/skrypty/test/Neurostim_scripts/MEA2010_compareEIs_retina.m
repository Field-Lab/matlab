...
T1=T1./0.27;
Chns=[233 234 241 242 243 249 250];
FigureProperties=struct('FigureNumber',5,'TimeRange',[0 59],'AmplitudeRange',[-600 200],'FontSize',28,'Colors',['b' 'r' 'k' 'y'],'XTick',[0 0.5 1 1.5 2 2.5 3 3.5],'YTick',[-80:20:40],'LineWidth',2,'YLabel','Signal [\muV]');
y=NS512_PlotClustersOfSignaturesOnArrayLayoutWithMarks3(T1,[Chns],[1 2],500,FigureProperties,NS_GlobalConstants,[144],[]);

h=gcf;
FullName=['C:\home\pawel\nauka\MEA2010\figures\' 'EIs_retina'];            
