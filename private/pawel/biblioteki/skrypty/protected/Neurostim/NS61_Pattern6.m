...
%MovieNumbers=MovieNumbers+2;

Amplitudes=Electrodes;

% DO NOT FORGET THIS !!!!!!!
for i=1:length(Electrodes)
    Amplitudes(i)=NS_PulseAmplitude('C:\home\pawel\2010\analysis\retina_61\2010-09-29-0\data002',Electrodes(i),Electrodes(i),MovieNumbers(i));
end

Neurons=[2 3 31 107 136 139 153 166 196];
...
startTime=24e4;
TimeRange=[startTime startTime+200000];
Times=[];
Patterns=[];
for i=1:length(Electrodes)
