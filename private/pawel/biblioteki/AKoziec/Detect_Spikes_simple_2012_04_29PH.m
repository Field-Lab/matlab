...
for i=1:length(Patterns)
    ...
    [AmplitudesVsChannels,RMSVsChannels,SamplesOutput]=NS512_FindThresholdForLocalStimulation4AK_PH2012_04_29(DataPath,WritePathFigsGood,WritePathFigsBad,PatternNumber,Movies,Channels,ArrayID,FigureProperties,NS_GlobalConstants,[],[MinDelay:45],SamplesNumber); %7 to 76
