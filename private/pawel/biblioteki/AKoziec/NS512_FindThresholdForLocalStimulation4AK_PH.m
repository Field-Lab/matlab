function [AmplitudesVsChannels,RMSVsChannelsAll,SamplesOutput]=NS512_FindThresholdForLocalStimulation4AK_PH(DataPath,WritePathFigsGood,WritePathFigsBad,PatternNumber,Movies,Channels,ArrayID,FigureProperties,NS_GlobalConstants,MarkedChannels,Samples,SamplesNumber);
...
for MovieNumber=Movies
    ...
    [Artifact]=NS512_ArtifactEstimationSomatic2(DataTraces,ArtifactThresholdNumber); %size of Artifact is 1 x 512 x 70
