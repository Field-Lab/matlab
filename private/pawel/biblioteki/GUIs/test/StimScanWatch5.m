function varargout = StimScanWatch5(varargin)
% STIMSCANWATCH5 M-file for StimScanWatch5.fig
%      STIMSCANWATCH5, by itself, creates a new STIMSCANWATCH5 or raises the existing
%      singleton*.
%
%      H = STIMSCANWATCH5 returns the handle to a new STIMSCANWATCH5 or the
%      handle to
%      the existing singleton*.
%
%      STIMSCANWATCH5('CALLBACK',hObject,eventData,handles,...) calls the
%      local
%      function named CALLBACK in STIMSCANWATCH5.M with the given input
%      arguments.
%
%      STIMSCANWATCH5('Property','Value',...) creates a new STIMSCANWATCH5
%      or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before StimScanWatch5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property
%      application
%      stop.  All inputs are passed to StimScanWatch5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help StimScanWatch5

% Last Modified by GUIDE v2.5 10-Aug-2010 14:41:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @StimScanWatch5_OpeningFcn, ...
                   'gui_OutputFcn',  @StimScanWatch5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before StimScanWatch5 is made visible.
function StimScanWatch5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to StimScanWatch5 (see VARARGIN)

% Choose default command line output for StimScanWatch5
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes StimScanWatch5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = StimScanWatch5_OutputFcn(hObject, eventdata, handles)
...
LowLimit=str2num(get(handles.edit8,'String'));
HighLimit=str2num(get(handles.edit9,'String'));
FigureProperties=struct('FigureNumber',12,'Subplot',[2 3 3],'TimeRange',[0 100],'AmplitudeRange',[LowLimit HighLimit],'FontSize',16,'Colors',['k' 'r' 'b' 'm' 'g' 'c' 'y'],'LineWidth',1,'YLabel','signal [mV]');
