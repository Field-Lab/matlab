...
%
%      STIMSCANWATCH3('Property','Value',...) creates a new STIMSCANWATCH3
%      or raises the
...
% Last Modified by GUIDE v2.5 10-Mar-2009 18:47:48
...
if IfAllEvents==1
    ...
    EventNumber=str2num(get(handles.edit23,'String'));
end
[DataTraces,ArtifactDataTraces,Channels]=NS_ReadPreprocessedData(DataPath,ArtifactDataPath,ArtifactSubtraction,PatternNumber,MovieNumber,100,EventNumber);
...
LowLimit=str2num(get(handles.edit8,'String'));
HighLimit=str2num(get(handles.edit9,'String'));
FigureProperties=struct('FigureNumber',12,'Subplot',[2 3 3],'TimeRange',[5 65],'AmplitudeRange',[LowLimit HighLimit],'FontSize',16,'Colors',['k' 'r' 'b' 'm' 'g' 'c' 'y'],'LineWidth',1,'YLabel','signal [mV]');
...
FigureProperties=struct('FigureNumber',4,'Subplot',[2 3 3],'TimeRange',[0 60],'AmplitudeRange',[LowLimit HighLimit],'FontSize',16,'Colors',['k' 'r' 'b' 'm' 'g' 'c' 'y'],'LineWidth',2,'YLabel','signal [mV]');
NS_GlobalConstants=NS_GenerateGlobalConstants(61);
