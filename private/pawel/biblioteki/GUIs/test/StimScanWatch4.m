function varargout = StimScanWatch4(varargin)
% STIMSCANWATCH4 M-file for StimScanWatch4.fig
%      STIMSCANWATCH4, by itself, creates a new STIMSCANWATCH4 or raises the existing
%      singleton*.
%
%      H = STIMSCANWATCH4 returns the handle to a new STIMSCANWATCH4 or the
%      handle to
%      the existing singleton*.
%
%      STIMSCANWATCH4('CALLBACK',hObject,eventData,handles,...) calls the
%      local
%      function named CALLBACK in STIMSCANWATCH4.M with the given input
%      arguments.
%
%      STIMSCANWATCH4('Property','Value',...) creates a new STIMSCANWATCH4
%      or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before StimScanWatch4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property
%      application
%      stop.  All inputs are passed to StimScanWatch4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help StimScanWatch4

% Last Modified by GUIDE v2.5 27-Aug-2010 20:59:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @StimScanWatch4_OpeningFcn, ...
                   'gui_OutputFcn',  @StimScanWatch4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before StimScanWatch4 is made visible.
function StimScanWatch4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to StimScanWatch4 (see VARARGIN)

% Choose default command line output for StimScanWatch4
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes StimScanWatch4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = StimScanWatch4_OutputFcn(hObject, eventdata, handles)
