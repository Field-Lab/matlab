function varargout = StimScanWatch4b(varargin)
% STIMSCANWATCH4B M-file for StimScanWatch4b.fig
%      STIMSCANWATCH4B, by itself, creates a new STIMSCANWATCH4B or raises
%      the existing
%      singleton*.
%
%      H = STIMSCANWATCH4B returns the handle to a new STIMSCANWATCH4B or the
%      handle to
%      the existing singleton*.
%
%      STIMSCANWATCH4B('CALLBACK',hObject,eventData,handles,...) calls the
%      local
%      function named CALLBACK in STIMSCANWATCH4B.M with the given input
%      arguments.
%
%      STIMSCANWATCH4B('Property','Value',...) creates a new STIMSCANWATCH4B
%      or raises the
%      existing singleton*.  Starting from the left, property value pairs
%      are
%      applied to the GUI before StimScanWatch4b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property
%      application
%      stop.  All inputs are passed to StimScanWatch4b_OpeningFcn via
%      varargin.
%
...
% Edit the above text to modify the response to help StimScanWatch4b

% Last Modified by GUIDE v2.5 18-Sep-2012 09:02:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @StimScanWatch4b_OpeningFcn, ...
                   'gui_OutputFcn',  @StimScanWatch4b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before StimScanWatch4b is made visible.
function StimScanWatch4b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to StimScanWatch4b (see VARARGIN)

% Choose default command line output for StimScanWatch4b
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes StimScanWatch4b wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = StimScanWatch4b_OutputFcn(hObject, eventdata, handles)
