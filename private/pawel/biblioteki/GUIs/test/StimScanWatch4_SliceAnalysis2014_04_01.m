function varargout = StimScanWatch4_SliceAnalysis2014_04_01(varargin)
% STIMSCANWATCH4_SLICEANALYSIS2014_04_01 M-file for StimScanWatch4_SliceAnalysis2014_04_01.fig
%      STIMSCANWATCH4_SLICEANALYSIS2014_04_01, by itself, creates a new STIMSCANWATCH4_SLICEANALYSIS2014_04_01 or raises the existing
%      singleton*.
%
%      H = STIMSCANWATCH4_SLICEANALYSIS2014_04_01 returns the handle to a new STIMSCANWATCH4_SLICEANALYSIS2014_04_01 or the
%      handle to
%      the existing singleton*.
%
%      STIMSCANWATCH4_SLICEANALYSIS2014_04_01('CALLBACK',hObject,eventData,handles,...) calls the
%      local
%      function named CALLBACK in STIMSCANWATCH4_SLICEANALYSIS2014_04_01.M with the given input
%      arguments.
%
%      STIMSCANWATCH4_SLICEANALYSIS2014_04_01('Property','Value',...) creates a new STIMSCANWATCH4_SLICEANALYSIS2014_04_01
%      or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before StimScanWatch4_SliceAnalysis2014_04_01_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property
%      application
%      stop.  All inputs are passed to StimScanWatch4_SliceAnalysis2014_04_01_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help StimScanWatch4_SliceAnalysis2014_04_01

% Last Modified by GUIDE v2.5 01-Apr-2014 17:56:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @StimScanWatch4_SliceAnalysis2014_04_01_OpeningFcn, ...
                   'gui_OutputFcn',  @StimScanWatch4_SliceAnalysis2014_04_01_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before StimScanWatch4_SliceAnalysis2014_04_01 is made visible.
function StimScanWatch4_SliceAnalysis2014_04_01_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to StimScanWatch4_SliceAnalysis2014_04_01 (see VARARGIN)

% Choose default command line output for StimScanWatch4_SliceAnalysis2014_04_01
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes StimScanWatch4_SliceAnalysis2014_04_01 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = StimScanWatch4_SliceAnalysis2014_04_01_OutputFcn(hObject, eventdata, handles)
