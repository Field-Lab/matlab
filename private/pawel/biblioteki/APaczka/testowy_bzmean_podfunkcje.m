...
%%% ELEKTRODY %%%%%% 
ArrayChannelRead=[1:3,5:8,10:24,26:30,32:56,58:63];   %%recznie wygenerowana tablica odczytu
...
for ElectrodeArrayCounter=1:2 %max(size(ArrayChannelRead))   %%60 elektrod (bez 4,9,25,31,57,64)    
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%           
                ...
                AnalizowanaPara(:,LicznikParElektrod)=[Elektroda_Stymulujaca,Elektroda_Odczytowa];   
                   AAAA=MovieNumberCounter
                   BBBBMvNumber=MovieNumber
                   
                 if MovieNumber == MovieDoAnalizy
                     inAAAA=MovieNumberCounter
