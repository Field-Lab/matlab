function [mean_spectrum, sd_spectrum] =  text_stc_significance(spike_times, cone_inputs, sig_dimensions, varargin)
...
p.addParamValue('iternation_number', 20, @isnumeric);
...
shifted_eig_vals = zeros(num_iters, size(cone_inputs,1) - sig_dimensions - 1);
