...
temp = load('~/Dropbox/Lab/Development/matlab-standard/private/lauren/MATLAB_code/analysis/dataset-specific/axonBundleThresholds_byPattern_2012_09_27_4_data009.mat');
axonBundleThresholds = temp.axonBundleThresholds_byPattern_2012_09_27_4_data009;
%%
...
figure; scatter(1:16,threshDiffDiffs); line([0 23], [0 0]); whitebg('black'); set(gcf, 'InvertHardCopy', 'off');
...
figure; plot(cat(2, maxThreshs_bielec1, bundleThreshs_copy(maxPatterns_bielec1))); whitebg('black'); title('bi-electrode axon vs soma thresh'); axis([1 16 0 4.5]); set(gcf, 'InvertHardCopy', 'off');
figure; plot(cat(2, maxThreshs_singleelec, bundleThreshs_copy(maxPatterns_singleelec))); whitebg('black'); title('single electrode axon vs soma thresh'); axis([1 16 0 4.5]); set(gcf, 'InvertHardCopy', 'off');
