...
datafile='nishal/2014-11-05-2/data009/data009';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2014_11_05_2_data009';
...
cell_params.cell_list=[3692,6076,2375,4413]; % if type_name_inp = 'userCellList' 
cell_params.use_fits=2;
cell_params.STAlen=14;
