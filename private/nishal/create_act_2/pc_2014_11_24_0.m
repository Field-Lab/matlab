...
datafile='nishal/2014-11-24-0/data000/data000';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2014_11_24_0_data000';
...
cell_params.cell_list=[1234,4013,5748,1066,2119]; % if type_name_inp = 'userCellList' 
cell_params.use_fits=2;
cell_params.STAlen=14;
