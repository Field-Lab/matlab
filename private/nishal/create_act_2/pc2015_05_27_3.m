...
datafile='2015-05-27-3/streamed/data001/data001';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_05_27_3_data001';
...
cell_params.cell_list=[4774,392,6527,226,3376,241,1353,6992];%[5119,4172,3093,1263,273,1426,5268,17,3277]%[3888,2825,1820,4129, 5346,5671,5161,1278, 3828,3574,4036,3572, 503,560,797,1009,487,181,901]; % if type_name_inp = 'userCellList' 
...
stim_length=1800;% 
cellID_list = [4774,392,6527,226,3376,241,1353,6992]
nSU_list= [3,3,3,3,3,3,3,3];
destination= 'pc-2015-05-27-3-gmlm'
