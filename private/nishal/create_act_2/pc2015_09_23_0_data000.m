...
datafile='2015-09-23-0/streamed/data000/data000';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_09_23_0_data000';
...
stim_length=1800;% 
cellID_list = [351,422,771,1067,1847,1939,2686,3061,4096,5746,5926,6826,7051,7396,7667,];%1006,1411,2086,2341,2686,4096,4276,4831,5371,5566,5596,5866,7156,7216,7381,7490];
nSU_list= 3*ones(1,length(cellID_list));
destination= 'pc2015_09_23_0_data000_glm'
