...
sizeClip=12;
sig_stixels(max([max_r-sizeClip/2,1]) : max_r+sizeClip/2,max([max_c-sizeClip/2,1]):max_c+sizeClip/2)=1;
sig_stixels=sig_stixels(1:size(rf_strength_out,1),1:size(rf_strength_out,2));
