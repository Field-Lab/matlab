...
datafile='2015-09-23-0/streamed/data017/data017';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_09_23_0_data017';
...
stim_length=1800;% 
cellID_list = [65,572,831,2148,2836,4160,5086,6108,7081,411,1067,2797,4733,5943,6181,7396];%1006,1411,2086,2341,2686,4096,4276,4831,5371,5566,5596,5866,7156,7216,7381,7490];
