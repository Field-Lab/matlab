...
datafile='2015-05-27-5/streamed/data015/data015';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_05_27_5_data015';
...
cell_params.cell_list=[2162,3916,6166,1010,4924,5702,1817,2311,6001,916,3136,5521];
...
mov_params.mdf_file = '/Volumes/Analysis/stimuli/white-noise-xml/BW-10-2-0.48-11111-32x32.xml';
...
movie_xml = 'RGB-10-2-0.48-11111-32x32';
stim_length=890;% 
cellID_list = [2162,3916,6166,1010,4924,5702,1817,2311,6001,916,3136,5521]
nSU_list= 2*ones(1,length(cellID_list));
destination= 'pc-2015-05-27-5-gmlm'
