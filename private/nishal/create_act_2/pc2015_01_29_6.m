...
startup_rooster
datafile='2015-01-29-6/data001/data001';%'nishal/2014-08-20-2/data001/data001';
...
cell_params=struct();
cell_params.type_name_inp='userCellList';%'userCellList';
cell_params.cell_list=[5401,4682,4145,3347,2948,1683,1352,1126,5268,4968,3577,3277,409];%[3888,2825,1820,4129, 5346,5671,5161,1278, 3828,3574,4036,3572, 503,560,797,1009,487,181,901]; % if type_name_inp = 'userCellList' 
cell_params.STAlen=14;
cell_params.sta_spatial=sprintf('%s/stas_spatial.mat',destination_mat);
cell_params.use_fits=2; % 2, 0,0,2
cell_params.sta_spatial_method=4;%1,2 ,3,4
...
cell_params.cell_list=[5119,4172,3093,1263,273,1426,5268,17,3277]; % if type_name_inp = 'userCellList' 
...
cell_params=struct();
cell_params.type_name_inp='userCellList';
cell_params.cell_list=[5401,4682,4145,3347,2948,1683,1352,1126,5268,4968,3577,3277,409];%[ % if type_name_inp = 'userCellList' 
cell_params.use_fits=2;
cell_params.STAlen=14;
...
mov_params=struct();
mov_params.mov_type='bw-precomputed';
mov_params.movie_time=120*3*60;
mov_params.mean=0.5*255;
mov_params.deviation=0.48*255;
mov_params.scaling_loss=0.01; % a number in [0,1], fraction of values that is changed by scaling.
%mov_params.mdf_file='/Volumes/Analysis/stimuli/white-noise-xml/BW-5-1-0.48-11111.xml'
