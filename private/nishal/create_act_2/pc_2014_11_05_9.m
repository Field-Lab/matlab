...
datafile='nishal/2014-11-05-9/data001/data001';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2014_11_05_9_data001';
...
cell_params=struct();
cell_params.type_name_inp='userCellList';
cell_params.cell_list=[3888,5346,3574,503]; % if type_name_inp = 'userCellList' 
cell_params.use_fits=2;
cell_params.STAlen=14;
