...
datafile='2015-05-27-7/streamed/data002/data002';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_05_27_7_data002';
...
cell_params.cell_list=[1561,1921,2821,3826,4141,4816,4922,5761,5806,6091,7563,7426,751,1486,1681,3229,4081,4381,5072,6661];
...
stim_length=1800;% 
cellID_list = [1561,2821,4141,4922,5806,7563,751,1681,4081,5072,6661]
nSU_list= 3*ones(1,length(cellID_list));
destination= 'pc-2015-05-27-7-gmlm'
...
mov_params=struct();
mov_params.mov_type='bw-precomputed';
mov_params.movie_time=120*60*7.5/2;
mov_params.mean=0.25*255;
mov_params.deviation=0.48*255;
