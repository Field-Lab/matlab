...
datafile='nishal/2014-09-16-2/data000/data000';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='stim2014-09-16-2';
...
cell_params=struct();
cell_params.type_name_inp='userCellList';%'Off Parasol'
cell_params.cell_list=[6392,621,2603,1758,2582,2375]; % if type_name_inp = 'userCellList' 
% TODO : Add region specific cell list
...
% write_movie_idx(destination_mat,movies{mov_idx},mov_idx);
% end
movie_list= [1,2,4,6,8,10,12,15,17];
