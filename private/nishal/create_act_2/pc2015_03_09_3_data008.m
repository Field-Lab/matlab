...
% This is uses 2015-03-09-3/data012 and data013. (See lisp code).

startup_bertha

startup_rooster

datafile='2015-03-09-3/streamed/data008/data008';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_03_09_3_data008';
...
cell_params.cell_list=[4083,1804,2448,5221,1068];%[5119,4172,3093,1263,273,1426,5268,17,3277]%[3888,2825,1820,4129, 5346,5671,5161,1278, 3828,3574,4036,3572, 503,560,797,1009,487,181,901]; % if type_name_inp = 'userCellList' 
...
mov_params=struct();
mov_params.mov_type='bw-precomputed';
mov_params.movie_time=120*1.5*60/4; % 15 min
mov_params.mean=0.5*255;
mov_params.deviation=0.48*255;
