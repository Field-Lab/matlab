...
datafile='2015-05-27-10/streamed/data002/data002';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_05_27_10_data002';
...
movie_xml = 'RGB-8-2-0.48-11111-40x40';
stim_length=1790;% 
cellID_list = [4309,6916,7276,5913,5152,2206,1771,1217]
nSU_list= 3*ones(1,length(cellID_list));
destination= 'pc2015_05_27_10-gmlm_data002'
...
movie_xml = 'RGB-8-2-0.48-11111-40x40';
stim_length=1790;% 
cellID_list = [571,871,2641,2941,3811,4398,4817,5776,6363,6571,7606,7623,7696]
nSU_list= 3*ones(1,length(cellID_list));
destination= 'pc2015_05_27_10-gmlm_data002'
[stas_t,stas_r] = get_gmlm_sta(datafile,movie_xml,stim_length,cellID_list,nSU_list,destination)
