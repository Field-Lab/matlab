...
datafile='2015-10-29-7/streamed/data012/data012';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_10_29_7_from_12';
...
stim_length=1800;% 
cellID_list = [557,7352,241,6182,5013,1563,2806,1983,136,3601,3062];
nSU_list= [1:14];
destination= 'pc2015_10_29_7_from_12/sus'
...
cellIDs=[557,7352,241,6182,5013,1563,2806,1983,136,3601,3062];
