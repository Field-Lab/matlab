...
datafile='nishal/2014-11-24-3/data005/data005';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2014_11_24_3_data005';
...
cell_params.cell_list=[1741,4531,3949,6961,3918,4261,7112,6994,76,92,7247,96,4427,4746,5540,5704]; % if type_name_inp = 'userCellList' 
cell_params.use_fits=2;
cell_params.STAlen=14;
