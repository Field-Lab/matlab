...
datafile='2015-08-17-0/streamed/data003/data003';%'nishal/2014-08-20-2/data001/data001';

% type_name_inp = 'userCellList' for a list of cells.

no_images_per_movie=10;
start_image=10;
tag='pc2015_08_17_0_data003';
...
cell_params.cell_list=[556,1278,1384,407,1516,2150,2401,3361,4066,4683,5611,6106,6005,7246,7562,3946];
...
destination= 'pc-2015-08-17-0-gmlm'
...
mov_params=struct();
mov_params.mov_type='bw-precomputed';
mov_params.movie_time=120*60*15/2;
mov_params.mean=0.5*255;
mov_params.deviation=0.48*255;
...
destination= 'pc-2015-08-17-0-gmlm3su'
[stas_t,stas_r] = get_gmlm_sta(datafile,movie_xml,stim_length,cellID_list,nSU_list,destination)
