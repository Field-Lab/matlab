...
function [C,U,V,stim,cvx_optval]=cvx_polar_admm_exp(data,data_event,radii_vec,theta_vec,time_sample_len,dict,lam,vec_len,wave_sample_len,stim_avg,mu,y_lag,gam,A_stim)
cvx_begin 
