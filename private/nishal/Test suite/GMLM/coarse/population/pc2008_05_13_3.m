...
WN_datafile = '2008-05-13-3/data003/data003';
...
totalMaskAccept_log = zeros(40*40,length(cells));
...
Y(icell_l,:) = spksGen;
 ...
 maskedMovdd= filterMov(mov,ones(size(mov,1),size(mov,2)),squeeze(ttf_avg));
  ...
  save('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2008_05_13_3/Off_type2.mat','maskedMovdd','Y','ttf_log','ttf_avg','totalMaskAccept_log','-v7.3')
