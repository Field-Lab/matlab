...
if ~exist(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/Off parasol/CellID_%d/gmlm/',cellID),'dir');
    mkdir(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/Off parasol/CellID_%d/gmlm/',cellID));
end

if ~exist(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/Off parasol/CellID_%d/gmlm/SU_%d',cellID,nSU),'dir');
    mkdir(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/Off parasol/CellID_%d/gmlm/SU_%d',cellID,nSU));
end
...
%% make occurance histogram
 ...
 hgexport(h,sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/Off parasol/CellID_%d/gmlm/Cell%d_gmlm_su_%d.eps',cellID,cellID,nSU));
save(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/Off parasol/CellID_%d/gmlm/Cell%d_gmlm_su_%d.mat',cellID,cellID,nSU),'su_log','fitGMLM_log');
