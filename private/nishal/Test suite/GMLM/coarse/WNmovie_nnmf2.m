...
%%
for cellID = [datarun.cell_types{1}.cell_ids];
...
if ~exist(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/',cellID),'dir');
    mkdir(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/',cellID));
end

if ~exist(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/SU_%d',cellID,nSU),'dir');
    mkdir(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/SU_%d',cellID,nSU));
end


hgexport(h,sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/SU_%d/Cell%d_nnmf_su_%d_fit_%d.eps',cellID,nSU,cellID,nSU,ifit));
...
%% make occurance histogram
 ...
 hgexport(h,sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/Cell%d_nnmf_su_%d.eps',cellID,cellID,nSU));
save(sprintf('/Volumes/Lab/Users/bhaishahster/GMLM_fits/pc2015_03_09_2/data038/On parasol/CellID_%d/nnmf/Cell%d_nnmf_su_%d.mat',cellID,cellID,nSU),'su_log','W_log','H_log','STX');
