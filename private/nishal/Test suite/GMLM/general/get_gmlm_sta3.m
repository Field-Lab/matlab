function [stas_true,stas_rand] = get_gmlm_sta3(WN_datafile,movie_xml,stim_length,cellID_list,nSU_list,destination,sta_depth)
...
colormap gray
%colorbar
title(sprintf('ki: %d, e(b): %0.02f',ifilt,(fitGMLM.Linear.filter{ifilt}(end))^2),'FontSize',10);
axis image
