...
function [pred,lam,nl_info] = predictGMLM_gamma2_lr_optimal_op_nl(fitGMLM,maskedMov,nTrials,interval,recorded_resp)
dt = 1/120;
[~,lam]=predictGMLM_gamma2_lr(fitGMLM,maskedMov,nTrials,2,interval);
