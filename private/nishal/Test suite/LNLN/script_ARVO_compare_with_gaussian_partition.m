...
dat2 = load('~/Google Drive/Presentations/Presentations/ASM_figures/modelCell_metric_smoothSU_control_gaussian.mat');
...
plotSU_filters(u_spatial_log,model);
[metric_gauss,metric_sus_gauss] = cutting_metric(model,u_spatial_log);
