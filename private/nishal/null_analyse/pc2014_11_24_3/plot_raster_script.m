...
%%
neuronPairsRefVsNew = crossIdentifyNeuronIDs('/Volumes/Analysis/2014-11-24-3/data012', '/Volumes/Analysis/2014-11-24-3/data014',InterestingCell_vis_id);
ref_cells=neuronPairsRefVsNew(:,2);
%%
neuronPath = '/Volumes/Analysis/2014-11-24-3/data014/data014.neurons';
...
TTLend=TTL((iTrial)*TTLperTrial+1);
