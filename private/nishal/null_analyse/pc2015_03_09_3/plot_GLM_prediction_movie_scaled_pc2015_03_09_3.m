function [spkCondCollGLM,h]=plot_GLM_prediction_movie_scaled_pc2015_03_09_3(cellID,condMov,GLMPath,mov_scales,rank)

col='krkrkrkrkrkrkr';

nTrials=30;
load(sprintf(strcat(GLMPath,'rk%d/%d.mat'),rank,cellID));
nmov =length(condMov);
