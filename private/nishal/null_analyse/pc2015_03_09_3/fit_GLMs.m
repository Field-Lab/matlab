...
for ref_cell_number=1:length(InterestingCell_vis_id); %11
   ...
   save(sprintf('/Volumes/Analysis/nishal/analyse_2015_03_09_3/data000/CellType_%s/CellID_%d.mat',datarun.cell_types{cellTypeId}.name,InterestingCell_vis_id(ref_cell_number)));
