...
nSU=2;        
destination =  'pc2015_11_09_8_analysis_fits/SUs_data028_exp';%'pc2015_11_09_8_analysis_fits/SUs_data007';
...
clear('ss');
icnt=0;
for icond=[1,2,3,4,5,6]%[1,2,3,4,5];
icnt=icnt+1;
