...
cond_str{1}='Original';
cond_str{2}='Spatial Null for Cell group A';
cond_str{3}='Spatial null for Cell group B';
cond_str{4}='Spatio-temporal null for Cell group A';
cond_str{5}='Spatio-temporal null forCell group B';
interestingConditions=[1,2,3,4,5,6];
%% Load Movies
rawMovFrames=7200;
[stim,height,width,header_size] = get_raw_movie('/Volumes/Analysis/nishal/pc2015_01_29_6/18.rawMovie',rawMovFrames,1);
...
WN_datafile = '2015-01-29-6/data001/data001';
Null_datafile = '/Volumes/Analysis/2015-01-29-6/data002-from-data001';
WN_mov='/Volumes/Analysis/stimuli/white-noise-xml/RGB-10-2-0.48-11111.xml';
WN_datafile_full = '2015-01-29-6/data001/data001';
imov=14;
