...
function plot_mosaic_pc2015_04_14_1(datarun,InterestingCell_vis_id,ref_cell_number,NullCells1,NullCells2)
% h=figure('Color','w');
...
hold on
plot_rf_fit(datarun,NullCells2,'fill_color',[0,0,1],'alpha',0.3,'fill',true,'edge',false,'labels',true,'edge_color',[1,0,0]);
