...
for ref_cell_number=1:length(InterestingCell_vis_id); %11
    ...
    pause(1/120);
     if(~isdir(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_11_09_1/d_add/CellType_%s',datarun.cell_types{cellTypeId}.name)))
         mkdir(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_11_09_1/d_add/CellType_%s',datarun.cell_types{cellTypeId}.name));
     end
    s=hgexport('readstyle','raster');
    hgexport(h,sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_11_09_1/d_add/CellType_%s/CellID_%d.eps',datarun.cell_types{cellTypeId}.name,InterestingCell_vis_id(ref_cell_number)),s);
end
