...
function [spkColl,spkCondColl,h]=plot_raster_script_pc2015_03_09_2_light_fig(cellID,nConditions,condDuration,cond_str,neuronPath,condDraw)
%%
...
plot(xPoints*1/20000, yPoints+(length(condDraw)-icnt)*nTrials1,col(icond));
hold on
ylim([0,length(condDraw)*nTrials]);
