...
Null_datafile = '/Volumes/Analysis/2015-04-09-0/stix16-norefit/data010-from-data010_data013_data014_data015_data011_data007_data012';
neuronPath = [Null_datafile,sprintf('/data010-from-data010_data013_data014_data015_data011_data007_data012.neurons')];
...
save(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data010/%d.mat',cellID),'WNSTA','home_spbins');

gmail('bhaishahster@gmail.com', 'A cell done');
end
  gmail('bhaishahster@gmail.com', 'data010 done')

%% Load spikes and format it.
% data013 - perturbed - coarse
mov = (perturbed_rep_4D-127.5)/255;

WN_datafile = '2015-04-09-0/stix16-norefit/data007-from-data010_data013_data014_data015_data011_data007_data012/data007-from-data010_data013_data014_data015_data011_data007_data012';
Null_datafile = '/Volumes/Analysis/2015-04-09-0/stix16-norefit/data013-from-data010_data013_data014_data015_data011_data007_data012';
neuronPath = [Null_datafile,sprintf('/data013-from-data010_data013_data014_data015_data011_data007_data012.neurons')];
...
save(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data013/%d.mat',cellID),'WNSTA','home_spbins');


gmail('bhaishahster@gmail.com', 'A cell done');
end
  gmail('bhaishahster@gmail.com', 'data013 done')
...
save(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data014/%d.mat',cellID),'WNSTA','home_spbins');


gmail('bhaishahster@gmail.com', 'A cell done');
end
  gmail('bhaishahster@gmail.com', 'data014 done')
...
WN_datafile = '2015-04-09-0/stix16-norefit/data007-from-data010_data013_data014_data015_data011_data007_data012/data007-from-data010_data013_data014_data015_data011_data007_data012';
Null_datafile = '/Volumes/Analysis/2015-04-09-0/stix16-norefit/data015-from-data010_data013_data014_data015_data011_data007_data012';
neuronPath = [Null_datafile,sprintf('/data015-from-data010_data013_data014_data015_data011_data007_data012.neurons')];
...
save(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data015/%d.mat',cellID),'WNSTA','home_spbins');

gmail('bhaishahster@gmail.com', 'A cell done');

end
  gmail('bhaishahster@gmail.com', 'data015 done')
...
%% See STAs
cellID = 1805;
pert_offset0 = load(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data010/%d.mat',cellID));

pert_offset2 = load(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data013/%d.mat',cellID));

base_offset0 = load(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data014/%d.mat',cellID));

base_offset2 = load(sprintf('/Volumes/Lab/Users/bhaishahster/analyse_2015_04_09_0/data015/%d.mat',cellID));

STAmagnitude = sum(base_offset0.WNSTA.^2,3);
max_val = max(STAmagnitude(:));
[r,c]=find(max_val==STAmagnitude);
mask = 0*STAmagnitude;
mask(r(1)-10:r(1)+10,c(1)-10:c(1)+10)=1;
mask=logical(repmat(mask,[1,1,30]));

mask_off = 0*STAmagnitude;
mask_off(r(1)-10:r(1)+10,c(1)-10:c(1)+10)=1; % Doubt
...
subplot(3,2,1);
a=pert_offset0;
b=reshape(a.WNSTA(mask),[21,21,30]);
imagesc(b(:,:,STAidx));
...
subplot(3,2,2);
a=pert_offset2;
b=reshape(a.WNSTA(mask_off),[21,21,30]);
imagesc(b(:,:,STAidx));
caxis([min(a.WNSTA(:)),max(a.WNSTA(:))]);
colormap gray
colorbar
...
subplot(3,2,5);
STA=pert_offset0.WNSTA - base_offset0.WNSTA;  % adjust scales
b=reshape(STA(mask),[21,21,30]);
imagesc(sum(b.^2,3));
caxis([min(b(:)),max(b(:))]);
colormap gray
colorbar
...
subplot(3,2,6);
STA=pert_offset2.WNSTA - base_offset2.WNSTA;  % adjust scales
b=reshape(STA(mask_off),[21,21,30]);
caxis([min(b(:)),max(b(:))]);
imagesc(sum(b.^2,3));
colormap gray
colorbar
