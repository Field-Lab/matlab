...
save(sprintf('/Volumes/Analysis/nishal/NSEM_SS/NSEM_dataset_%s_cell%d_data00%d_a_%dcells.mat',dataset,vision_id,imov,no_cells),'waveforms','spike_times','spike_amps','recon_snippets','init_waveform_all_channels','imov','dataset','analysis_datafile','bin_datafile','vision_id');
