%%
function fcn_run_ss(analysis_datafile,bin_datafile,vision_id,no_cells,noise,save_location)
imov=1;
% type_name= cell(1,1);
...
save(save_location,'waveforms','spike_times','spike_amps','recon_snippets','init_waveform_all_channels','analysis_datafile','bin_datafile','vision_id','no_cells');
end
