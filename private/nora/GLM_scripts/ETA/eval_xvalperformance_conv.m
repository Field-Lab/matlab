...
function [xvalperformance] = eval_xvalperformance_conv(fittedGLM,testspikes,testmovie,inputstats,testneighborspikes)
%%
...
logicalspike( binnumber )  =  logicalspike( binnumber ) + 1;
