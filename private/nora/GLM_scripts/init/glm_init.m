...
function glm_init(n_iter, exps,stimtypes,celltypes,cell_subset,glm_settings, runoptions)
            ...
            for i_cell = 1:length(cellgroup)
                ...
                if ~exist(sprintf('%s/%s.mat', Dirs.fittedGLM_savedir,cell_savename)) || (exist('replace_existing','var') && replace_existing)
                    ...
                    for i_iter = 1:n_iter
                        ...
                        % Made new folder for each iteration
                        ...
                        if isfield(GLMType, 'DoubleOpt') && GLMType.DoubleOpt
                            ...
                            [fittedGLM] = glm_execute_init(GLMType,fitspikes_concat,fitmovie_concat,...
