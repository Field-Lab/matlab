function plot_GLM_rasters(exp_nm, cid, GLMType)
...
plotraster(xvalperformance_cross,fittedGLM_NSEM, true, false, true)
plotraster(fittedGLM_NSEM.xvalperformance,fittedGLM_NSEM, true, false, true)
plotraster(fittedGLM_WN.xvalperformance,fittedGLM_WN, true, false, true)
