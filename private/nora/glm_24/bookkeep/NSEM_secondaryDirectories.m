...
switch directory_type
	case 'savedir_GLMfit'
        ...
        directory = sprintf('%s/%s/%s_%s/%s', GLMoutput, fitname, stim_type, map_type,exp_nm);
        %{
        if exist('condition', 'var')
