...
function [fstar,pstar] = glm_execute_DoubleOpt_InnerLoop(outer_optimizing_par,optimizing_type,glm_cellinfo, GLMType, GLMPars,fixed_covariates,home_spbins,fitmovie,t_bin,p_init,troubleshoot)
