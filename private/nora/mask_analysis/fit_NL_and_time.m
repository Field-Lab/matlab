...
for iter = 1:iterations
    ...
    model = fitnlm(gen_signal, firing_rate, 'y~b1./(b2+exp(b3*x1))', NL_init);
    ...
    new_time = fminunc(@(time_course)timecourse_error_function(time_course, firing_rate, model, gen_signal_spatial, fittedGLM.linearfilters.TonicDrive.Filter), t_init);
    t_init = new_time;
    clear new_time;
