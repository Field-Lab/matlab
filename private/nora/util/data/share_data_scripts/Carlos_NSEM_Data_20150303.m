...
for i_cell = 1:length(cells)
    ...
    eval(['NSEMCellData.' cell_savename '.Spikes=organizedspikes.block.t_sp_withinblock;'])
    eval(['NSEMCellData.' cell_savename '.STA=STAandROI.STA;'])
    
end

% Save data structures
save('NSEMStimData.mat','NSEMStimData');
save('NSEMCellData.mat','NSEMCellData');
clear; close all;  clc
