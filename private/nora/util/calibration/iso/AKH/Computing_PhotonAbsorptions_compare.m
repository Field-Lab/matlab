...
RGB_recordedWatts_rigB = (10^-2)*(10^-6)*[1.52 1.78 1.77];  % 240 by 240 pixels 
RGB_recordedWatts_rigA = (10^-3)*(10^-6)*[4.0 4.7 3.6];  % 240 by240 pixels
stimarea_micronsq =  24*26*100*100; %
