...
for cell_type = {'On Parasol', 'Off Parasol'}
    ...
    [NSEM_Corr,locations, prof2] = wide_field(datarun, cell_type, stim_end, 0);
    Corr_NS = [Corr_NS; NSEM_Corr(:,3)];
    Loc = [Loc ; locations];
    ...
    [NSEM_Corr,locations, prof3] = wide_field(datarun, cell_type, stim_end, 0);
...
%     %%
    ...
    [NSEM_Corr,locations, prof4] = wide_field(datarun, cell_type, stim_end, 0);
    Corr_NS = [Corr_NS; NSEM_Corr(:,3); NSEM_Corr(:,4)];
    Loc = [Loc ; locations];
