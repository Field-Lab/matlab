function  [a] = glm_FitAccuracy1(Basepars, computespikemetrics, simspertrial)
%%% AK Heitman  2012-01-08
...
[StimulusPars DirPars datarun_all]  = Directories_Params_func_all(Basepars.exp_nm, Basepars.GLMPars.debug); 
...
FinalSpace_AnalysisDir =sprintf('%s/FinalSpace_Analysis',DirPars.output_dir);
if Basepars.debug_mode, FinalSpace_AnalysisDir =sprintf('%s/dbug_FinalSpace_Analysis',DirPars.output_dir); end
if (~isdir(FinalSpace_AnalysisDir)),mkdir(FinalSpace_AnalysisDir); end    
