function init_pars = postspike_coupling_filterparams(init_pars);
...
if init_pars.Coupling
    init_pars.cp_timebins = floor((init_pars.spikebins_perstimframe*init_pars.k_stimframes)*init_pars.cp_fratio); % on fine timescale ~ 6/factor m(s)^-1
