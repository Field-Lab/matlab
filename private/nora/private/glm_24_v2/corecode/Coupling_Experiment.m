exp_nm = '2012-08-09-3';  head_cellID = [1471 1786 7066 1276 1426];
%exp_nm = '2012-09-27-3';  head
%%% Coupling Experiment
...
if strcmp(runtype, 'local')
    homedir = local_homedir;
end
if strcmp(runtype, 'network')
    homedir = network_homedir;
end
cd(homedir);
%load('Cell1_fixPS.mat');  % fixPS_p
path(homedir, path);



%%%%%% DEFINE A SET OF DEFAULT VALUES
default.GLMPars.binning= 10;      
default.GLMPars.maxiter = 1000;      % 
default.GLMPars.tolx = 9;    
default.GLMPars.tolfun = 5;          % default 5
default.GLMPars.filt_mode = 'STA'; 
