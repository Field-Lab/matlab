...
function [SimandMetrics] = simtorastermetrics_streamlined(Basepars,StimulusPars,DirPars,datarun_all,plotRaster_dir, computespikemetrics, simspertrial)
...
for count = 1:2  
    ...
    if count == 1
        stim_vrf = 'BW';   Slv_StimPars = StimulusPars.BW;   computespmetric = computespikemetrics.BW;  datarun = datarun_BW;
    elseif count == 2
        stim_vrf = 'NSEM'; Slv_StimPars = StimulusPars.NSEM; computespmetric = computespikemetrics.NSEM; datarun = datarun_NSEM;
    end
