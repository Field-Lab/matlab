...
%             mglFlush;
%
function texture = mglCreateTexture(image,  privateFunc, axes, liveBuffer, textureParams)
...
if nargin == 5
  ...
  texture = privateFunc(image, axes, liveBuffer, textureParams);
elseif nargin == 4
  texture = privateFunc(image,axes,liveBuffer);
elseif nargin == 3
  texture = privateFunc(image,axes);
elseif nargin == 2
  texture = privateFunc(image);
else
