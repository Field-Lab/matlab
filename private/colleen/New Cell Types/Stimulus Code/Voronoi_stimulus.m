...
%% ------------------------------ INPUTS -----------------------------------
cells = {7700};
file_name = '2015-04-09-5/data009/data009';
mdf_file='/Volumes/Analysis/stimuli/white-noise-xml/BW-10-8-0.48-11111-8x6-169.xml';
file_path = ['/Users/colleen/matlab/private/colleen/New Cell Types/Stimulus Code/2014-04-14-3/data008_', num2str(cells{1}), '.txt'];
...
%     sig_stixels = significant_stixels(sta);
    sig_stixels = significant_stixels(sta, 'select', 'thresh', 'thresh', 0.25)
