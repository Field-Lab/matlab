...
%% 2016-02-17-1 data007-cf/edited/data007-cf
try
dataparam.date='2016-02-17-1/data007-cf/edited';
dataparam.concatname='data007-cf';
dataparam.mdf_file='/Volumes/Analysis/stimuli/white-noise-xml/RGB-16-2-0.48-22222-119.5.xml';
dataparam.select_cells = 1;
dataparam.cell_specification =[91 213 320 391 768 856 1216 1489 1891 2056 2523 2627 3181 3243 3391 3392 3393 3603 3797 3886 3931 3932 4127 4336 4846 4921 5072 5898 6736 6781 6856 7066 7067 7306 7353 7487 7550];
sta = run_jitter(dataparam);
...
%% 2016-02-17-6 data024-cf/edited/data024-cf
try
dataparam.date='2016-02-17-6/data024-cf/edited';
dataparam.concatname='data024-cf';
dataparam.mdf_file='/Volumes/Analysis/stimuli/white-noise-xml/RGB-8-2-0.48-33333-119.5.xml';
dataparam.select_cells = 1;
dataparam.cell_specification =[185 481 545 814 871 931 1216 1441 1477 1786 1936 1939 1986 2161 2431 2991 3031 3289 3436 3442 3618 3811 3812 3901 3902 4326 4893 4897 4982 5026 5061 5478 5521 5916 6094 6212 6511 6526 7056 7277 7473];
sta = run_jitter(dataparam);
...
close all
clear 
%% 2016-02-17-6 data026-mVision/data026
try
dataparam.date='2016-02-17-6/data026-mVision';
dataparam.concatname='data026';
dataparam.mdf_file='/Volumes/Analysis/stimuli/white-noise-xml/RGB-16-2-0.48-22222-119.5.xml';
dataparam.select_cells = 1;
dataparam.cell_specification =[185 241 1383 1759 1787 1941 1944 2011 3048 3901 4113 4981 5011 5912 6526 7068 7356 7476 481 812 1533 1981 2161 3408 3813 3890 4276 4973 6513 439 541 1442 2432 3438 5027 6213 2122];
sta = run_jitter(dataparam);
