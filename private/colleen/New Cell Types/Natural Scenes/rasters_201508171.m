...
concatname='d01-29-norefit';
finalname='';
nmruns=['data005'; 'data010'; 'data014']; % NSEM runs
staruns=['data006'; 'data007'; 'data001']; % long WN runs for STA
stacoarseruns=['data006'; 'data021'; 'data025']; % coarse long WN runs for STA

wnruns=['data004'; 'data009'; 'data012' ]; % WN repeats
cell_specification = [394 964 1143];
num_repeats = 20;
movie_length = 30000; % in ms
wn_length = 30000; % in ms
...
sta_coords = [0.05 0.0, 0.12,0.23;...
    0.2 0.0, 0.12,0.23;0.35 0.0, 0.12,0.23];

sta_coords_coarse = [0.50 0.0, 0.12,0.23;...
    0.65 0.0, 0.12,0.23;0.8 0.0, 0.12,0.23];
