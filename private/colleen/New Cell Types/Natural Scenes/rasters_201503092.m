...
sta_coords = [0.05 0.2, 0.12,0.12;...
   0.2 0.2, 0.12,0.12;
    0.35 0.2, 0.12,0.12;
    0.5 0.2, 0.12,0.12;
    0.65 0.2, 0.12,0.12;];

sta_coords_coarse = [0.05 0.05, 0.12,0.12;...
    0.2 0.05, 0.12,0.12;
    0.35 0.05, 0.12,0.12;
    0.5 0.05, 0.12,0.12;
    0.65 0.05, 0.12,0.12;];
...
for i=1:length(cell_numbers)
    ...
    % plot stuff
    fig=figure('PaperPosition',[0 0 12 10],'PaperSize',[12 10]);
    set(fig,'color','white','position',[82 242 1785 856]);
    
    % plot NSEM
    h=subplot('position',[0.05 0.65, 0.9,0.25]);
...
%     save(['Cell_' int2str(visionID)], 'nmrasters');
    ...
    % plot WN repeats
    h=subplot('position',[0.05 0.38, 0.9,0.25]);
...
%         title('NDF 5.0, 26')
    ...
    h=subplot('position',[0.8 0.03, 0.15,0.15]);
    sta_tc=zeros(30,5);
