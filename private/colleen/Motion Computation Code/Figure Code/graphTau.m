...
meanOnP0_03 = mean(stdOnP(tau == 0.03));
meanOffP0_03 = mean(stdOffP(tau == 0.03));
meanOnM0_03 = mean(stdOnM(tau == 0.03));
...
meanOnP0_003 = mean(stdOnP(tau == 0.003));
meanOffP0_003 = mean(stdOffP(tau == 0.003));
meanOnM0_003 = mean(stdOnM(tau == 0.003));
...
mean0_03 = mean([meanOnP0_03, meanOffP0_03, meanOnM0_03])
mean0_01 = mean([meanOnP0_01, meanOffP0_01, meanOnM0_01])
mean0_005 = mean([meanOnP0_005, meanOffP0_005, meanOnM0_005])
mean0_003 = mean([meanOnP0_003, meanOffP0_003, meanOnM0_003])
...
semilogx(0.03,mean0_03, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b');
semilogx(0.01, mean0_01, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b');
semilogx(0.005, mean0_005, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b');
semilogx(0.003, mean0_003, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b');
semilogx(0.001, mean0_001, 'bo-', 'LineWidth', 2, 'MarkerFaceColor', 'b');

xlim([0.0005 0.2])
% ylim(axes_lim)
set(gca, 'xtick', [0.001,0.003,  0.005,0.01,0.03, 0.05, 0.1]);
set(gca, 'xticklabel',{'.001', '.003','.005', '.01','.03','.05' ,'.1'})
