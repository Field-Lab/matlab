...
% Last Modified by GUIDE v2.5 13-Jan-2015 09:57:38
...
function showTemplates(tempRecElec, sampleRange)

% Project onto template waveform
neuronPath = '/Volumes/Analysis/2014-11-24-2/data001/data001.neurons';
...
ei_path = '/Volumes/Analysis/2014-11-24-2/data001/data001.ei';
...
sampleRange        = 1:40;
showTemplates(tempRecElec, sampleRange);
