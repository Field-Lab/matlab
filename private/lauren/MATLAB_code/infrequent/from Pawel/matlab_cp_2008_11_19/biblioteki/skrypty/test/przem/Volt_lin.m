function [slope,lin_err]=Volt_lin(dac,dane0);
...
glob_emax=100;                   %glob_emax - najwieksza wartosc bledu maksymelnego dla najlepiej dopasowanego wspolczynnika nachylenia
