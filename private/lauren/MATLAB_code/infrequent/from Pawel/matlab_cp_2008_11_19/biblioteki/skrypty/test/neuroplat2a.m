%Pomiar wzmocnienia trzema metodami: sinus z zewn. generatora, prostokat z zewn. generatota, kalibracja. Przy pomiarze z gen. korzystano z zewnetrznego tlumika (tlumik na plytce nieuzywany), generator hp8116A. Sygnal 10mV (najmniejszy mozliwy). Pomiar poziomu sygnalu na oscyloskopie za pomoca fft, stosunek wysokosci piku fft do rzeczywistej amplitudy zmierzony dla duzej amplitudy z generatora. Do pomiaru poziomu sygnalu z kalibracji wykorzystano tryb external_source, na wejsci sygnal z wyjscia trigger gen. - dokladnie ta sama czestotliwosc, wiec rozmycie pika w fft identyczne (skalowanie sygnalu).
...
h1=legend('external sinus','external square','internal calibration');
set(h1,'FontSize',fontsize);
h1=xlabel('frequency');
set(h1,'FontSize',fontsize);
ylabel('gain');
