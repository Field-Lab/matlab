...
dl=400;
[y1,y2]=inveyefilter_hayes(dl,18,20,8300,20000); %oszacowanie efektu filtrowanai w neurochipie
...
figure(4)
loglog(freq_y1(1:dl-1),diff(faza/360)*length(faza)/max(freq_y1)*1e6)
xlabel('frequency [Hz]');
