...
%
% returns 
%     PCx, PCy: the PCs identities of the PCs used in the chosen plot.
%
%
% in old version:  PCx = PCy = 0 signifies that
%     the button "cluster all remaining" was pressed.
%
% written by Lauren Hruby 2008-09-08
% last edited 2008-09-09
% edited 2008-11-25: cluster all remaining button removed
