function [PatternsOut,Times,MovieChunk]=NS_MovieChunksForExperimentDistancePairs(nTargets,Array,TimeShiftInMs,DelayInMs,NumberOfSamples);
...
Delay=round(DelayInMs*20/nTargets + 1);
