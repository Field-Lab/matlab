function z=fastcorr(a,b,zasieg,wykladnik);
%z=fastcorr(a,b,zasieg,wykladnik);
...
okno_2=okno-zasieg(1)-zasieg(2);  %o tyle przesuwa sie okno w kolejnej iteracji petli
...
for i=1:ilosc
    ...
    pocz1=(i-1)*okno_2+1;  %pierwsza probka rekordu dla "a"
    koniec1=(i-1)*okno_2+okno;  %ostatnia dla "a"
    pocz2=pocz1+zasieg(1);  %pierwsza dla "b"
    koniec2=koniec1-zasieg(2); %ostatnia dla "b"
...
e0=ifft(f);   % wyrzucic za petle !!! (sumowac w dziedzinie f)
clear f;
e0=real(e0);
