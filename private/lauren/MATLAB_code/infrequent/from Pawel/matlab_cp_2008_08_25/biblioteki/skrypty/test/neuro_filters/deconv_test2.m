...
for j=1:length(filenames)
    if find(spikes(:,1)==j)'
        ...
        name_write=['gunpg' num2str(i) '_raw.txt'];
        tabelka=[t; spike1];
        fidw=fopen(name_write,'w');
        fprintf(fidw,'%12.8f %12.8f\n',tabelka);
        fclose(fidw);
        
        name_write=['gunpg' num2str(j) '_deconv.txt'];
        tabelka=[t; spike2];
        fidw=fopen(name_write,'w');
        fprintf(fidw,'%12.8f %12.8f\n',tabelka);
        fclose(fidw);
...
for j=1:length(filenames)
    if find(spikes(:,1)==j)'
        ...
        name_write=['malpa' num2str(j) '_raw.txt'];
        tabelka=[t; spike1];
        fidw=fopen(name_write,'w');
        fprintf(fidw,'%12.8f %12.8f\n',tabelka);
        fclose(fidw);
        
        name_write=['malpa' num2str(j) '_deconv.txt'];
        tabelka=[t; spike2];
        fidw=fopen(name_write,'w');
        fprintf(fidw,'%12.8f %12.8f\n',tabelka);
        fclose(fidw);
