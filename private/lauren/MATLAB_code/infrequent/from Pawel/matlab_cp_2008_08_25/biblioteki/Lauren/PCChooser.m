...
% allows the user to choose which PC plot best separates data clusters
%
% arguments
...
h.gui = figure('Visible', 'off', 'Position',[100 100 800 600],... 
    'Name', 'Choose which PC plot gives the best cluster separation.', 'Resize', 'off');

h.p1h = axes('Parent', h.gui, 'Units', 'pixels', 'Position', [50 300 200 200]);
...
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'PC1 vs PC2', 'Position', [50 500 200 30],...
    'Callback', @PC12);
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'PC1 vs PC3', 'Position', [300 500 200 30],...
    'Callback', @PC13);
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'PC1 vs PC4', 'Position', [550 500 200 30],...
    'Callback', @PC14);
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'PC2 vs PC3', 'Position', [50 250 200 30],...
    'Callback', @PC23);
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'PC2 vs PC4', 'Position', [300 250 200 30],...
    'Callback', @PC24);
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'PC3 vs PC4', 'Position', [550 250 200 30],...
    'Callback', @PC34);
uicontrol(h.gui, 'Style', 'pushbutton', 'String', 'cluster all remaining',...
    'Position', [300 550 200 30], 'Callback', @clusterAll);
