...
y(1,:)=maxim(filename,length,stim_channel);

filename='ch28_14uA_01ms_Vpol-14_waterconv';
y(2,:)=maxim(filename,length,stim_channel);

filename='ch28_25uA_01ms_Vpol-14_waterconv';
y(3,:)=maxim(filename,length,stim_channel);

filename='ch28_52uA_01ms_Vpol-14_waterconv';
y(4,:)=maxim(filename,length,stim_channel);

filename='ch28_110uA_01ms_Vpol-14_waterconv';
y(5,:)=maxim(filename,length,stim_channel);

filename='ch28_11uA_10ms_Vpol-14_waterconv';
y(6,:)=maxim(filename,length,stim_channel);

filename='ch28_14uA_10ms_Vpol-14_waterconv';
y(7,:)=maxim(filename,length,stim_channel);

filename='ch28_25uA_10ms_Vpol-14_waterconv';
y(8,:)=maxim(filename,length,stim_channel);

filename='ch28_52uA_10ms_Vpol-14_waterconv';
y(9,:)=maxim(filename,length,stim_channel);

filename='ch28_110uA_10ms_Vpol-14_waterconv';
y(10,:)=maxim(filename,length,stim_channel);
