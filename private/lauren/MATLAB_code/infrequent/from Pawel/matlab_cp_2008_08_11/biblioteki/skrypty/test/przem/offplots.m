...
figure(1);
plot(dac,dane1,dac,dane2,dac,dane3,dac,dane4,dac,dane5,dac,dane6,dac,dane7,dac,dane8,dac,dane9,dac,dane10,dac,dane11,dac,dane12,dac,dane13,dac,dane14);
...
set(h,'FontSize',16);
set(h,'LineWidth',1.5);
set(h,'XLim',[-130,130],'YLim',[-2.2 2.5] );
