function [thresholds threshStds details] = generateBasicClusterStimPlotPairsOnly(pathToData, patternNos, pElec, neuronID, varargin)
%
%
%
%
...
error('This function is deprecated!  The original has been split into extractPattrernStimAnalysis.m and pairPatternPlots.m')
...
for ii = 1:nPatterns
    ...
    elecResp = checkForUnfinishedAnalysis(temp.elecResp, 100, 'recalcAll', false, 'useRobustFitting', useRobustFitting, 'checkForAnalysisGaps', checkForAnalysisGaps);
    ...
    %being phased on
    [baseAmps{ii}, elecs{ii}] = getStimAmps(elecResp.names.data_path, elecResp.stimInfo.patternNo, elecResp.stimInfo.movieNos(1));
    %end phased out
