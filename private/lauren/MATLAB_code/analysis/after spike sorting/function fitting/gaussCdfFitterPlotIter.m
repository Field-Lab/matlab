...
if setParam == 1 %hold parameter 1 constant
    estimatedParam2 = fminsearch(@(param2)gaussCdfFunPlotIter([param1 param2], data), start, options);
    estimatedParams = [param1 estimatedParam2];
elseif setParam == 2 %hold parameter 2 constant
    estimatedParam1 = fminsearch(@(param1)gaussCdfFunPlotIter([param1 param2], data), start, options);
    estimatedParams = [estimatedParam1 param2];
else
    estimatedParams = fminsearch(@(nlParams)gaussCdfFunPlotIter(nlParams, data), start, options);
end
