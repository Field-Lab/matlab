...
% edit text boxes
if strcmp('/', filesep) %mac
    main.filePath = uicontrol(main.topLeftPanel, 'Style', 'edit', 'String', '/Volumes/Analysis/2012-09-24-3/data003/',...
...
main.fileName = uicontrol(main.topLeftPanel, 'Style', 'edit', 'String', 'elecResp_n2318_p140.mat',...
...
%checkbox
main.fixedLimsCB = uicontrol(main.topLeftPanel, 'Style', 'checkbox', 'Value', true, 'String', 'use elecResp',...
...
main.increaseOccButton = uicontrol(main.topLeftPanel, 'Style', 'pushbutton', 'String', 'next occ.',...
    'Position', [280 112 70 20], 'Callback', funH.increaseOccNo, 'fontsize', 9);
...
main.markFlaggedCheckBox = uicontrol(main.midRightPanel, 'Style', 'checkbox', 'Units', 'pixels',...
    'Position', [10 225 130 20], 'String', 'mark flagged', 'ForegroundColor', 'black',...
    'Visible', 'off', 'Value', 0, 'BackgroundColor', [1 1 1], 'fontsize', 8);

main.artFromSubsetCheckBox = uicontrol(main.midRightPanel, 'Style', 'checkbox', 'Units', 'pixels',...
    'Position', [10 207 130 20], 'String', 'exclude flagged', 'ForegroundColor', 'black',...
    'Visible', 'off', 'Value', 0, 'BackgroundColor', [1 1 1], 'fontsize', 8);
main.artFromSubsetText = uicontrol(main.midRightPanel, 'style', 'text', 'Units', 'pixels',...
    ...
    'BackgroundColor', 'white', 'visible', 'off', 'fontsize', 8);
