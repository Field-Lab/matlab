function y=NS_PlotManySignaturesOnArrayLayoutNew(Traces,Channels,WaveformTypes,ArrayID,FigureProperties,NS_GlobalConstants);
...
for i=1:NumberOfChannels
    ...
    %traceMean = mean(Data, 1);
    %for j = 1:size(Data, 1)
    %   Data(j,:) = Data(j,:) - traceMean;
    %end
    h=plot(Data');
