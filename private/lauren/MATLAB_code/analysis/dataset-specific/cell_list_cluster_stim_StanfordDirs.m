function cellInfo = cell_list_cluster_stim_StanfordDirs(badElecThresh)
...
cellInfo(x).pathToData = '/Volumes/Analysis/2008-08-26-0/data008';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2008-08-26-0/data007-NW/axonDirData.mat';
...
cellInfo(x).pathToData = '/Volumes/Analysis/2008-08-27-4/data005';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2008-08-27-4/data004-NW/axonDirData.mat';
cellInfo(x).withTriplets = false;
cellInfo(x).tripletsAnalyzed = false;
cellInfo(x).xPlotLim = [-1 1];
cellInfo(x).yPlotLim = [0 1];
...
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2008-11-12-3/data002';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2008-11-12-3/data000/axonDirData.mat';
cellInfo(x).withTriplets = false;
cellInfo(x).tripletsAnalyzed = false;
...
cellInfo(x).pathToData = '/Volumes/Analysis/2011-01-11-0/data032';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-01-11-0/data030/axonDirData.mat';
...
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2011-05-11-8/data003_004/';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-05-11-8/data001/axonDirData.mat';
cellInfo(x).withTriplets = true;
cellInfo(x).tripletsAnalyzed = true;
...
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2011-07-05-5/data004';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-07-05-5/data000/axonDirData.mat';
cellInfo(x).withTriplets = false;
cellInfo(x).tripletsAnalyzed = false;
cellInfo(x).xPlotLim = [-2.5 2.5];
cellInfo(x).yPlotLim = [0 2.5];
...
cellInfo(x).patternNos = 304:606;
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2011-07-14-7/data003';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-07-14-7/data000/axonDirData.mat';
cellInfo(x).withTriplets = true;
cellInfo(x).tripletsAnalyzed = true;
cellInfo(x).xPlotLim = [-2.5 2.5];
cellInfo(x).yPlotLim = [0 2.5];
...
cellInfo(x).patternNos = 1:87;
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2011-08-01-0/data005';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-08-01-0/data000/axonDirData.mat';
cellInfo(x).withTriplets = false;
cellInfo(x).tripletsAnalyzed = false;
...
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2011-08-04-5/data006_007';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-08-04-5/data000/axonDirData.mat';
cellInfo(x).withTriplets = true;
cellInfo(x).tripletsAnalyzed = false;
...
cellInfo(x).excludePatterns = [];
cellInfo(x).pathToData = '/Volumes/Analysis/2011-12-13-0/data009';
cellInfo(x).pathToAxonDirData = '/Volumes/Analysis/2011-12-13-0/data005/axonDirData.mat';
cellInfo(x).withTriplets = false;
cellInfo(x).tripletsAnalyzed = false;
cellInfo(x).xPlotLim = [-4 4];
...
% cellInfo(x).excludePatterns = [];
% cellInfo(x).relAmps = [];
% cellInfo(x).pathToData = '/Volumes/Analysis/';
% cellInfo(x).withTriplets = ;
% cellInfo(x).tripletsAnalyzed = ;
% cellInfo(x).xPlotLim = [];
% cellInfo(x).yPlotLim = [];
