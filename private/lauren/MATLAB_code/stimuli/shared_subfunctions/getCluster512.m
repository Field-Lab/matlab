function clusterElectrodes = getCluster512(centerElectrode, varargin)
...
maxDist = p.Results.maxDistance*60; %factor of 60 because closest neighbor distance in getElectrodeCoords512 is 2
