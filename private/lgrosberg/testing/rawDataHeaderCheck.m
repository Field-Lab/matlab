...
pathToLabViewOutputFiles = '/Volumes/Data/2015-09-23-6/'; 
newFileFolder = '/Volumes/Analysis/2015-09-23-6/data001_copy';
if ~exist(newFileFolder,'dir')
    mkdir(newFileFolder);
end

datarun = '000';
originalDataFilePath= ['/Volumes/Data/2015-09-23-6/data' datarun];
