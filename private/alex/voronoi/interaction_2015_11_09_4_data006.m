...
%SC run 1
datarun = load_data('/Volumes/Analysis/2015-11-09-4/d00-8-norefit/data001/data001');
datarun = load_params(datarun,'verbose',1);
datarun = load_sta(datarun);

%SC run 2
datarun2 = load_data('/Volumes/Analysis/2015-11-09-4/d00-8-norefit/data005/data005');
datarun2 = load_params(datarun2,'verbose',1);
datarun2 = load_sta(datarun2);

% voronoi run
vorrun = load_data('/Volumes/Analysis/2015-11-09-4/d00-8-norefit/data006/data006');
vorrun = load_params(vorrun,'verbose',1);
vorrun = load_sta(vorrun);
vorrun = load_neurons(vorrun);
[inputs, refresh, duration] = get_wn_movie_ath(vorrun, 'BW-1-1-0.48-11111-686x1-60.35.xml');


%% plot stuff
save_path = '/Volumes/Analysis/2015-11-09-4/data006_d00-8/';
nbins_cone1 = 8;
nbins_cone2 = 8;
...
for kkk= vorrun.cell_types{1, 1}.cell_ids(19:end)  %vorrun.cell_ids(22:end)
    close all
