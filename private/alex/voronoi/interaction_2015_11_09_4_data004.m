...
% voronoi run
vorrun = load_data('/Volumes/Analysis/2015-11-09-4/d00-8-norefit/data004/data004');
vorrun = load_params(vorrun,'verbose',1);
vorrun = load_sta(vorrun);
vorrun = load_neurons(vorrun);
[inputs, refresh, duration] = get_wn_movie_ath(vorrun, 'BW-1-1-0.48-11111-136x1-60.35.xml');


%% plot stuff
save_path = '/Volumes/Analysis/2015-11-09-4/data004_d00-8/';
nbins_cone1 = 8;
nbins_cone2 = 8;
...
for kkk= vorrun.cell_types{1, 5}.cell_ids(1:end)  %vorrun.cell_ids(22:end)
    close all
