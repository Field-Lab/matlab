...
% try just taking mean of all stimulus frames
...
figure
imagesc(q)
save('/Users/alexth/Desktop/noise_BW_2_6_11111.mat', 'p', 'q')
clear inputs 
...
for i=1:10
    ...
    colormap gray
    imagesc(tmp2)
    title(['denoised without sig stix, ', num2str(robust_mean(tmp2(:))), ' + ', num2str(robust_std(tmp2(:)))])
    ax3 = subplot(1,3,3);
    colormap gray
    imagesc(tmp)
...
tmp = mean(all_sta1(:,:,cell_inds(1:end)),3);
figure
set(gcf, 'position', [-1753 529 1679 536])
ax1 = subplot(1,3,1);
imagesc(tmp);
