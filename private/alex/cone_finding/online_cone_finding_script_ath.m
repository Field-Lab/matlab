...
s_path='/Volumes/Analysis/';
% datarun = load_data(fullfile(s_path, '2013-10-10-5/streamed/data002/data002'));
...
% load('/Users/alexth/Desktop/variables_conefinding_bayes.mat')
%%
...
datarun = load_java_movie(datarun, '/Volumes/Analysis/movie-xml/BW-2-5-0.48-11111-300x300-60.35.xml')

%%
cell_types = {5};%{1,2,3,4,5};
...
%         bcf_params.C_C = [3.5 4.0]; % distance prior
%           bcf_params.C_C = [7.0 8.0]; % distance prior for S cones
...
bcf_params.roi_x_size = 2*bcf_params.padding_x + 10; % was +10 before
...
%%
magic_number = 5
save_bayesian_cones(datarun, bcf, bcf_params, magic_number, ['prior7_Scones_',extra_dirname_info], false, [], 'fit_foa', [], 'robust_std_method', 1);
toc
