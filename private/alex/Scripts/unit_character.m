...
set(gcf,'position',[1  31 1680 946],'color',[1 1 1]*0.8);
for i=1:7
    subplot('Position',[0.7 0.03+(0.14*(i-1)) 0.15 0.12])
    subplot('Position',[0.03 0.03+(0.14*(i-1)) 0.65 0.12])
    subplot('Position',[0.87 0.03+(0.14*(i-1)) 0.12 0.12])
end
...
figure
imagesc(a)
fill(1:length(cdata),[0,ones(1,length(cdata)-2),0],cdata);
