...
experiment_date = '2015-11-09-*';


alldirs=dir(fullfile('/Volumes/Data',experiment_date));
cnt=1;
...
param_content=cell(500,length(field_names));
...
fid1=fopen(['/Users/alexth/Desktop/stimuli_db_',experiment_date(1:10),'.txt'],'w');
for i=1:size(comb,1)
    for j=1:25
        tmp =comb{i,j};
        if iscell(tmp)
