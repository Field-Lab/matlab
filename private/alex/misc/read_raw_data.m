...
raw_data_path='/Volumes/Data/9999-99-99-9/data002';
...
figure
plot(tmp, '-*')
axis([0 length(tmp) 4 16])

hold on
figure
plot(diff(time_stamps)*1000)
diff(find(diff(time_stamps)*1000>12)*robust_mean(diff(time_stamps)*1000))/1000 % in s
