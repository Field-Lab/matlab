...
dataparam.date = '2015-03-09-2';
dataparam.concatname = 'data011';

dataparam.file_name_right = [dataparam.date, '/d05-27-norefit/', dataparam.concatname,'/', dataparam.concatname];
