...
dataparam.date = '2011-12-13-2';
dataparam.concatname = 'data008-from-d08_11';

dataparam.file_name_right = [dataparam.date, '/d08-11-norefit/', dataparam.concatname,'/fake/', dataparam.concatname];

dataparam.cell_type = {'OFF midget'};

fitparam.num_frames = 6;
mark_params.thresh = 3; %threshold for significant stixels;
...
select_cells = 0;
if select_cells == 1
    dataparam.cell_specification = [112] %
end

%% END OF INPUT
dataparam.folder = dataparam.cell_type{1};
% file path to save data and pictures
dataparam.filepath=['/Users/alexth/Desktop/Fitting/',dataparam.date,'/',dataparam.concatname,'/'];
...
paramPath = ['/Volumes/Analysis/', dataparam.date, '/d05-27-norefit/', dataparam.concatname,'/', dataparam.concatname, '.params'];
